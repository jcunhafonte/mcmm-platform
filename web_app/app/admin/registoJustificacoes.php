...
Menus('justificacoes', 'visualizarJustificacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-file-text-o'></i> Justificações</h1>

                <h3>Verifique as justificações já adicionadas aos seus colaboradores</h3></div>
...
if (isset($_GET['justificacaoRemovida'])) {

    $colaboradorRemovido = $_GET['justificacaoRemovida'];
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A justificação do colaborador <b>$nomeCompletoRemovido</b> foi removida com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

if (isset($_GET['justificacaoRemovidaErro'])) {

    $colaboradorRemovido = $_GET['justificacaoRemovidaErro'];
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao remover a justificação do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoJustificacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Justificações</h2>
...
justificacoes.ref_id_colaborador = colaborador.id_colaborador WHERE colaborador.ativo = 1
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td><a href='perfilColaborador.php?colaborador=$refIdColaborador'><span id='titulo$idJustificacao'>$colaboradorNomeJustificacao</span></a></td>
                                            <td>$funcaoColaborador</td>
                                            <td>$textoDataJustificacao";
        if(!empty($dataJustificacaoFim)){
            echo " - $textoDataJustificacaoFim";
        }
        echo "</td>
                                            <td>$motivoJustificacao</td>
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>

                                            <a href='editarJustificacao.php?justificacao=$idJustificacao' data-toggle='tooltip' title='Editar Justificação'
                                                       class='text-center btn btn-default'><i class='fa fa-edit'></i></a>

                                                <a data-href='php/verificacoes/verificaCancelarJustificacao.php?colaborador=$refIdColaborador&justificacao=$idJustificacao'
                                                    data-toggle='tooltip' title='Remover Justificação' class='md-trigger text-center btn btn-default'
                                                      onclick='modalRemover($idJustificacao);' id='botaoRemover$idJustificacao'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Justificações - <strong>$nomeCompletoApresenta</strong></h2>
    ...
    $query = "SELECT justificacoes.id_justificacao, justificacoes.ref_id_colaborador, justificacoes.data_justificacao,
justificacoes.motivo, colaborador.nome_completo, colaborador.funcao, justificacoes.fim_justificacao FROM justificacoes
INNER JOIN colaborador ON justificacoes.ref_id_colaborador = colaborador.id_colaborador WHERE colaborador.ativo = 1
AND justificacoes.ref_id_colaborador = ? ORDER BY colaborador.nome_completo ASC";
