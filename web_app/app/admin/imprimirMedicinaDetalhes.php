...
if ((!isset($_SESSION['ativoAdmin']))) {
    ...
    if ((!isset($_GET['colaborador']) AND (!isset($_GET['medicina'])))) {
...
colaborador.id_colaborador, colaborador.ativo, colaborador.morada, colaborador.funcao, colaborador.categoria, colaborador.telemovel,
 colaborador.telefone, colaborador.codigo_postal,colaborador.localidade FROM medicina
INNER JOIN colaborador ON colaborador.id_colaborador = medicina.ref_colaborador
WHERE colaborador.ativo = 1 AND medicina.id_medicina = ? ORDER BY colaborador.nome_completo ASC ";

$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_param($stmt,'i', $_GET['medicina']);
mysqli_stmt_bind_result($stmt, $idMedicina, $tipoConsultaMedicina,
    ...
    $ativoColaborador,  $moradaColaborador, $funcaoColaborador, $categoriaColaborador, $telmColaborador, $telfColaborador,
    $codPostalColaborador, $localidadeColaborador);
mysqli_stmt_execute($stmt);
mysqli_stmt_fetch($stmt);
mysqli_stmt_close($stmt);

$conversaoDataComportamento = new DateTime($dataConsultaMedicina);
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Medicina de Trabalho</h1>
...
<tr><td>&nbsp;</td></tr>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Tipo</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$tipoConsultaMedicina</h4>

								</td>
								</tr>";

if(!empty($fichaAptidaoMedicina)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Ficha de Aptidão</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$fichaAptidaoMedicina</h4>

								</td>
								</tr>";}

if(!empty($aptidaoMedicina)){
echo "
									<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Apto</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$aptidaoMedicina</h4>
						...
						<tbody>
							...
							<tr>
								<td style='width:50%!important; text-align: center !important; padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important; text-align: center'>($nomeCompletoColaborador)</h4>
