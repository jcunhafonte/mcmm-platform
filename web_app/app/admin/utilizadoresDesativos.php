    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                ...
                <h3>Verifique os utilizadores inativos, reative-os ou edite dados</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['utilizadorReativo'])) {

                        $utilizadorReativo = $_GET['utilizadorReativo'];

                        $query = "SELECT id_utilizador, nome_utilizador FROM utilizadores
                        WHERE id_utilizador = ?";

                        $stmt = mysqli_prepare($link, $query);
                        mysqli_stmt_bind_param($stmt, 'i', $utilizadorReativo);
                        mysqli_stmt_bind_result($stmt, $idUtilizadorReativo, $nomeCompletoReativo);
               ...
               O utilizador <b>$nomeCompletoReativo</b> foi reativado com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['utilizadorReativoErro'])) {

                        $utilizadorReativo = $_GET['utilizadorReativoErro'];
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao reativar o utilizador <b>$nomeCompletoReativo</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                      ...
                                      idade, funcao, data_registo FROM utilizadores
                                      WHERE ativo = ? ORDER BY nome_utilizador ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $ativo);
                                        mysqli_stmt_bind_result($stmt, $idUtilizador, $nomeUtilizador, $email, $idade, $funcao, $dataRegisto);
                                        mysqli_stmt_execute($stmt);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            */
                                            ...
                                            echo "<tr>
                                            <td>
                                            <a href='../perfil.php?utilizador=$idUtilizador'><span id='titulo$idUtilizador'>$nomeUtilizador</span></a>
                                            </td>
                                            <td>";
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    <a href='../perfil.php?utilizador=$idUtilizador' data-toggle='tooltip' title='Ver Perfil' class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                    <a data-href='php/verificacoes/verificaReativarUtilizador.php?utilizador=$idUtilizador' data-toggle='tooltip' title='Reativar Utilizador' class='text-center btn btn-default md-trigger' onclick='modalRemover($idUtilizador);' id='botaoRemover$idUtilizador' data-target='#md-fade-in-scale-up'  data-modal='md-fade-in-scale-up'><i class='fa fa-user-plus'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
