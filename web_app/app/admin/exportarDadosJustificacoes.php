...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Justificações</title>
...
Menus('exportarDados', 'qualidadeJustificacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
               <h1><i class='fa fa-table'></i> Exportar Dados - Justificação</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosJustificacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                             <h2><strong>Justificação</strong></h2>
...
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td>$colaboradorNomeJustificacao</td>
...
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td style='text-align: center !important;'>$colaboradorNomeJustificacao</td>
                                            <td style='text-align: center !important;'>$funcaoColaborador</td>
                                            <td style='text-align: center !important;'>$textoDataJustificacao";
        if(!empty($dataJustificacaoFim)){
            echo " - $textoDataJustificacaoFim";
        }
        echo "</td>
                                            <td style='text-align: center !important;'>$motivoJustificacao</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
...
<br><br><br><br>
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Justificação</strong> - <strong>$nomeCompletoApresenta</strong></h2>
   ...
   <table width='100%'>
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                                <td>
                                            <h3><strong>Formação</strong> - <strong>$nomeCompletoApresenta</strong></h3>
                                            </td>
                                            </tr>
                                </table>
    ...
    $query = "SELECT justificacoes.id_justificacao, justificacoes.ref_id_colaborador, justificacoes.data_justificacao, justificacoes.motivo,
colaborador.nome_completo, colaborador.funcao FROM justificacoes INNER JOIN colaborador ON
justificacoes.ref_id_colaborador = colaborador.id_colaborador WHERE colaborador.ativo = 1 AND justificacoes.ref_id_colaborador = ?
ORDER BY colaborador.nome_completo ASC";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt,'i',$colaborador);
    mysqli_stmt_bind_result($stmt, $idJustificacao, $refIdColaborador, $dataJustificacao, $motivoJustificacao,
        $colaboradorNomeJustificacao, $funcaoColaborador);
    mysqli_stmt_execute($stmt);
