...
Menus('estatisticas','estatisticasDesvinculacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Entrevistas de Desvinculação</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Entrevistas de desvinculação por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Entrevistas de Desvinculação por ano</h2>
...
$query = "SELECT YEAR( data_desvinculacao ) , funcao, COUNT( id_desvinculacao )
FROM desvinculacao WHERE YEAR( data_desvinculacao ) = ?";
...
echo "{ y: '$inicioDataDesvinculacao', a: $resultadoAju},";
...
$inicioDataDesvinculacao = $inicioDataDesvinculacao + 1;
                ...
                xkey: 'y',
                ykeys: ['a'],
                labels: ['Número de Desvinculações']
            });
        });
