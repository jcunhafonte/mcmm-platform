...
if ((!isset($_SESSION['ativoAdmin']))) {
    ...
    if ((!isset($_GET['colaborador']) AND (!isset($_GET['marcacao'])))) {
...
marcacao_consulta.data_consulta, marcacao_consulta.ref_id_colaborador,

colaborador.nome_completo, colaborador.id_colaborador, colaborador.ativo, colaborador.morada,
colaborador.funcao, colaborador.categoria, colaborador.telemovel, colaborador.telefone,
colaborador.codigo_postal,colaborador.localidade

FROM marcacao_consulta
...
mysqli_stmt_bind_param($stmt,'i', $_GET['marcacao']);
mysqli_stmt_bind_result($stmt, $idMarcacao, $tipoConsultaMedicina,
    $dataConsultaMedicina, $refIdColaboradorMedicina,


    $nomeCompletoColaborador, $idColaborador,
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Marcação Medicina de Trabalho</h1>
    ...
    <table width='100%'>
                                <thead>
                                 ...
                                 <tr width='100%'>
									...
									<h3>MARCAÇÃO MEDICINA DE TRABALHO</h3>
							<h4>BN-$idMarcacao</h4>
							</td>
                                            </tr>
                                </table>
