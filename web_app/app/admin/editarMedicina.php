...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        ...
        <div>
            <p>Tem a certeza que pretende remover esta consulta do colaborador <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação não pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da remoção, pode voltar a adicionar consultas ao colaborador.
                </li>
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-fa fa-stethoscope'></i> Medicina de Trabalho</h1>
                <span style='display: none !important;' id='titulo$idMedicina'>$nomeCompletoColaborador</span>
                  <div class='text-right' style='height: 73px !important; padding-top: 10px !important;'>
								<div class='row text-right'>
									<div class='col-lg-4 text-right' style='float: right!important;'>
                                          <a data-href='php/verificacoes/verificaCancelarConsulta.php?colaborador=$idColaborador&medicina=$idMedicina'
                                                     title='Remover Consulta'
                                                     onclick='modalRemover($idMedicina);' id='botaoRemover$idMedicina'
                                                      data-target='#md-fade-in-scale-up'  data-modal='md-fade-in-scale-up'
                                                       class='md-trigger'>
                                        <button type='button' class='text-right btn btn-danger btn-sm'>
										<i class='fa fa-remove'></i> Remover Consulta</button></a>
...
echo "<div class='widget'>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaEditarMedicina.php?medicina=$medicina'>
                        <div class='form-group'>
...
while (mysqli_stmt_fetch($stmt)) {
    ...
    if($refColaboradorMedicina == $idColaborador){echo "selected";}
...
echo "</select>
       ...
       echo " value='A - Exames de Admissão'><b>A - Exames de Admissão</b></option>
        ...
        if($fichaAptidaoMedicina == "Sim"){
            echo "checked";
        }
                                                       echo " value='Sim' name='fichaAptidaoColaborador'> Sim
                                            </label>
                                            <label>
                                                <input type='radio' name='fichaAptidaoColaborador' ";
        if($fichaAptidaoMedicina == "Não"){
            echo "checked";
...
<div class='col-sm-2'>
                                            ...
                                            <label>
                                                <input type='radio' id='optionsRadios1' ";
        if($aptidaoMedicina == "Sim"){
            echo "checked";
        }
                                                      echo " value='Sim' name='aptoColaborador'> Sim
                                            </label>
                                            <label>
                                                <input type='radio' name='aptoColaborador' ";
        if($aptidaoMedicina == "Não"){
            echo "checked";
        }
        echo " id='optionsRadios2' value='";echo "Não"; echo "'> Não
                                            </label>
</div>
                        </div>
