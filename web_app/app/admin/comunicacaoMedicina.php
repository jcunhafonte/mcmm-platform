...
Menus('comunicacoes', 'comunicacaoMedicina');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                  <h1><i class='fa fa-comments'></i> Comunicações - Medicina de Trabalho</h1>

                <h3>Selecione a consulta que deseja ver impressa para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoMedicina.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Medicina de Trabalho</h2>
                                            ...
                                            <td>$aptidaoMedicina</td>
                                               <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    <a href='imprimirMedicinaDetalhes.php?colaborador=$idColaborador&medicina=$idMedicina'
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Medicina de Trabalho - <strong>$apresentaNomeFormacoes</strong></h2>
