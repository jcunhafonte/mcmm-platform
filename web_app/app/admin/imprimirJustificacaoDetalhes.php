...
if ((!isset($_SESSION['ativoAdmin']))) {
    ...
    if ((!isset($_GET['colaborador']) AND (!isset($_GET['justificacao'])))) {
...
justificacoes.motivo, colaborador.nome_completo, colaborador.funcao, justificacoes.fim_justificacao, colaborador.morada,
colaborador.funcao, colaborador.categoria,colaborador.telemovel, colaborador.telefone, colaborador.codigo_postal,
colaborador.localidade FROM justificacoes
INNER JOIN colaborador ON justificacoes.ref_id_colaborador = colaborador.id_colaborador WHERE colaborador.ativo = 1
AND justificacoes.id_justificacao = ? ORDER BY colaborador.nome_completo ASC";

$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_param($stmt, 'i', $_GET['justificacao']);
mysqli_stmt_bind_result($stmt, $idJustificacao, $refIdColaborador, $dataJustificacao, $motivoJustificacao,
    $colaboradorNomeJustificacao, $funcaoColaborador, $dataJustificacaoFim, $moradaColaborador, $funcaoColaborador,
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Justificação</h1>
						...
						<table class='teste' width='100%'>
							<tbody>
								...
								<tr>
									<td width='40%'></td>
									<td width='60%' style='text-align: right'>
									  $colaboradorNomeJustificacao<br>
...
if (empty($dataJustificacaoFim)) {
    ...
    echo "<tr>
								<td>
								<h3 style='display: inline;'>DATA INÍCIO: </h3>
								<h3 style='display: inline; font-weight: normal !important;'>
								$textoDataJustificacao</h3>
								</td>
								</tr>";
    echo "<tr>
								...
								<h3 style='display: inline;'>DATA FIM: </h3>
								<h3 style='display: inline; font-weight: normal !important;'>
								$textoDataJustificacaoFim</h3>
								</td>
								</tr>";
}
...
echo "<tr><td>&nbsp;</td></tr>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important;'>$motivoJustificacao</h4>
						...
						<tbody>
							...
							<tr>
								<td style='width:50%!important; text-align: center !important; padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important; text-align: center'>($colaboradorNomeJustificacao)</h4>
