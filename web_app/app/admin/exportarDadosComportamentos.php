...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Comportamentos Não Aceitáveis</title>
...
Menus('exportarDados', 'qualidadeComportamento');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
               <h1><i class='fa fa-table'></i> Exportar Dados - Comportamentos Não Aceitáveis</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosComportamentos.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comportamentos Não Aceitáveis</strong></h2>
                                ...
                                <form class='form-horizontal' role='form'>
                                    <table id='datatables-4' class='table table-striped table-bordered' cellspacing='0'
                                        ...
                                        <tr>
                                            ...
                                            <th>Descrição</th>
                                            <th>Danos</th>
                                               <th>Situação Recorrente e/ou Grave</th>
                                             <th>Análise das Causas</th>
                                               <th>Pessoas a Envolver</th>
                                               <th>Tipo de Sanção</th>
                                             <th>Comentários</th>
                                             <th>Oportunidade de Melhoria</th>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        $conversaoDataComportamento = new DateTime($dataComportamento);
        $textoDataComportamento = $conversaoDataComportamento->format('d-m-Y');

        echo "<tr>
                                            <td>$nomeComportamento</td>
                                            <td>$textoDataComportamento</td>
                                            <td>$descricaoComportamento</td>
                                            <td>$danosComportamento</td>
                                            <td>$situacaoComportamento</td>
                                            <td>$analiseComportamento</td>
                                            <td>$pessoasComportamento</td>
                                            <td>$sancaoComportamento</td>
                                            <td>$comentariosComportamento</td>
                                            <td>$melhoriaComportamento</td>
                                            <td>$documentosComportamento</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>Comportamentos Não Aceitáveis</strong></h3>
                                            </td>
                                            </tr>
                                </table>";

    $query = "SELECT comportamentos.id_comportamentos, colaborador.nome_completo, colaborador.ativo
FROM comportamentos INNER JOIN colaborador ON comportamentos.ref_id_colaborador = colaborador.id_colaborador
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_result($stmt, $idComportamento2, $nomeComportamento, $ativoComportamento);
    mysqli_stmt_execute($stmt);
    ...
    $query2 = "SELECT comportamentos.id_comportamentos, comportamentos.ref_id_colaborador,
comportamentos.data_comportamento, comportamentos.descricao, comportamentos.danos, comportamentos.situacao,
comportamentos.analise, comportamentos.pessoas, comportamentos.sancao, comportamentos.comentarios,
comportamentos.melhoria, comportamentos.documentos, colaborador.nome_completo, colaborador.ativo
FROM comportamentos INNER JOIN colaborador ON comportamentos.ref_id_colaborador = colaborador.id_colaborador
WHERE colaborador.ativo = 1 AND comportamentos.id_comportamentos = ? ORDER BY colaborador.nome_completo ASC ";

    $stmt2 = mysqli_prepare($link2, $query2);
        mysqli_stmt_bind_param($stmt2, 's', $idComportamento2);
    mysqli_stmt_bind_result($stmt2, $idComportamento, $refIdColaborador, $dataComportamento, $descricaoComportamento,
        $danosComportamento, $situacaoComportamento, $analiseComportamento, $pessoasComportamento, $sancaoComportamento,
        $comentariosComportamento, $melhoriaComportamento, $documentosComportamento, $nomeComportamento, $ativoComportamento);
    ...
    mysqli_stmt_fetch($stmt2);
        ...
        echo "<tr>
                                            ...
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$textoDataComportamento</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$descricaoComportamento</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$danosComportamento</td>
                                        </tr>";
...
WHERE colaborador.ativo = 1 AND comportamentos.id_comportamentos = ? ORDER BY colaborador.nome_completo ASC ";
    ...
    mysqli_stmt_fetch($stmt2);
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$situacaoComportamento</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$analiseComportamento</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$pessoasComportamento</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$sancaoComportamento</td>
                                        </tr>";
    mysqli_stmt_close($stmt2);
...
WHERE colaborador.ativo = 1 AND comportamentos.id_comportamentos = ? ORDER BY colaborador.nome_completo ASC ";
  ...
  mysqli_stmt_fetch($stmt2);
        ...
        echo "<tr>
                                            <td style='text-align: center !important;'>$comentariosComportamento</td>
                                            <td style='text-align: center !important;'>$melhoriaComportamento</td>
                                            <td style='text-align: center !important;'>$documentosComportamento</td>
                                        </tr>";
    mysqli_stmt_close($stmt2);
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comportamentos Não Aceitáveis</strong> - <strong>$nomeCompletoApresenta</strong></h2>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td width='70%'>
                                            <h3><strong>Comp. Não Aceitáveis</strong> - <strong>$nomeCompletoApresenta</strong></h3>
                                            </td>
                                            </tr>
                                </table>";
...
WHERE colaborador.ativo = 1 AND colaborador.id_colaborador = ? ORDER BY colaborador.nome_completo ASC ";
    ...
    mysqli_stmt_bind_result($stmt, $idComportamento2, $nomeComportamento2, $ativoComportamento2);
    mysqli_stmt_execute($stmt);

    while (mysqli_stmt_fetch($stmt)) {

        echo "<table border='1' id='' class=' table-striped table-bordered' cellspacing='0'
                                           width='100%'>
                                        <thead>
                                        <tr>
                                            <th>Nome</th>
