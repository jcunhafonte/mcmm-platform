...
<div class='md-modal md-just-me' id='logout-modal'>
    <div class='md-content'>
           <h1><i class='fa fa-comments'></i> Comunicações - Presenças</h1>

                <h3>Selecione o registo de presenças que deseja ver impresso para apresentar ao seu colaborador</h3>
...
Menus('comunicacoes', 'comunicacaoPresencas');
...
echo "
 <div class='widget col-sm-12'>
                        <div class='widget-header transparent'>
                            <h2><strong>Inserir data de consulta</strong> (Mês e Ano) e <strong>Colaborador</strong></h2>
                        ...
                        <div class='widget-content padding'>
                            <form class='form-horizontal' role='form' method='get'
                                  action='comunicacaoPresencas.php'>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Presenças - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>Todos os Colaboradores</strong></h2>
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo $subsidioAlimentacao; echo ",00€</td>
                                           <td class='text-center'>
                                                ...
                                                <a href='imprimirPresencaDetalhes.php?colaborador=$idColaborador&mesPresenca=$mes&anoPresenca=$ano'
...
if ((!isset($_GET['mesPresenca'])) AND (!isset($_GET['anoPresenca']))
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Presenças</h2>
    ...
    function getWorkingDays($startDate, $endDate)
{
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Presenças - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis</h2>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Presenças - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>$apresentaNomeFormacoes</strong></h2>
