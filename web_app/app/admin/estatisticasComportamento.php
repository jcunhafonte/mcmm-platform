...
Menus('estatisticas', 'estatisticasComportamento');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Comportamentos Não Aceitáveis</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de comportamentos não aceitáveis por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Número de comportamentos não aceitáveis por ano</h2>
...
$query = "SELECT YEAR( data_comportamento ), COUNT( id_comportamentos )
FROM comportamentos WHERE YEAR( data_comportamento ) = ?";
...
$inicioDataAdmissao = $inicioDataAdmissao + 1;
            ...
            xkey: 'y',
            ykeys: ['a'],
            labels: ['Número de Comportamentos']
        });
