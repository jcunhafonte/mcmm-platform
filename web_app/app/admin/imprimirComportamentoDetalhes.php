...
colaborador.morada, colaborador.funcao, colaborador.categoria, colaborador.telemovel,
...
mysqli_stmt_bind_param($stmt, 'i', $_GET['comportamento']);
mysqli_stmt_bind_result($stmt, $idComportamento, $refIdColaborador, $dataComportamento, $descricaoComportamento,
    ...
    $moradaColaborador, $funcaoColaborador, $categoriaColaborador, $telmColaborador, $telfColaborador,
    $codPostalColaborador, $localidadeColaborador);
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Comportamento Não Aceitável</h1>
    ...
    <table width='100%'>
                                <thead>
                                 ...
                                 <tr width='100%'>
									...
									<h3>COMPORTAMENTO NÃO ACEITÁVEL</h3>
							<h4>BN-$idComportamento</h4>
							</td>
                                            </tr>
                                </table>
...
<tr><td>&nbsp;</td></tr>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important;'>$descricaoComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Danos na Empresa</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$danosComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Situação Recorrente e/ou Grave</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$situacaoComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Análise das Causas</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$analiseComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Pessoas a Envolver</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$pessoasComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Tipo de Sanção</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$sancaoComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important;'>$comentariosComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Oportunidade de Melhoria</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$melhoriaComportamento</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Documentos Anexos</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$documentosComportamento</h4>
						...
						<tbody>
							...
							<tr>
								<td style='width:50%!important; text-align: center !important; padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important; text-align: center'>($nomeComportamento)</h4>
