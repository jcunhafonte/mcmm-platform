...
if ((!isset($_SESSION['ativoAdmin']))) {
    ...
    if ((!isset($_GET['colaborador']) AND (!isset($_GET['formacao'])))) {
...
formacoes.descricao, formacoes.duracao, formacoes.entidade, colaborador.nome_completo,
        colaborador.id_colaborador, colaborador.ativo, colaborador.morada, colaborador.funcao, colaborador.categoria,
        colaborador.telemovel, colaborador.telefone, colaborador.codigo_postal,colaborador.localidade
        FROM formacoes INNER JOIN colaborador ON colaborador.id_colaborador = formacoes.ref_id_colaborador
...
mysqli_stmt_bind_result($stmt, $idFormacoes, $refIdColaboradorFormacoes, $anoFormacoes,
    ...
    $idColaboradorFormacoes, $ativoFormacoes, $moradaColaborador, $funcaoColaborador, $categoriaColaborador,
    $telmColaborador, $telfColaborador, $codPostalColaborador, $localidadeColaborador);
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Formação</h1>
...
if(!empty($telfColaborador) OR $telfColaborador != 0){
								...
								<tr>
								<td>
								<h3 style='display: inline;'>ANO: </h3>
...
<tr><td>&nbsp;</td></tr>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important;'>$descricaoFormacoes</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Duração</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>";if($duracaoFormacoes == 1){
    echo $duracaoFormacoes . " hora";
}else{
    echo $duracaoFormacoes . " horas";
}
echo "</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Entidade</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$entidadeFormacoes</h4>
						...
						<tbody>
							...
							<tr>
								<td style='width:50%!important; text-align: center !important; padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important; text-align: center'>($nomeFormacoes)</h4>
