    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float:left !important;'><i class='fa fa-exchange'></i> Mudanças de Função</h1>

                 <span style='display: none !important;' id='titulo$refIdColaborador'>$nomeMudanca</span>
...
if (isset($_GET['sucesso'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A mudança de função do colaborador <b>$nomeCompletoAdicionada</b> foi editada com sucesso.<br>
...
if (isset($_GET['erro'])) {
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao editar a mudança de função do colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Editar</strong> Mudança</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaEditarMudanca.php?mudanca=$mudanca'>
                        <div class='form-group'>
                            <label class='col-sm-2 control-label'>Colaborador</label>";

                            echo "<div class='col-sm-10'>
                                <select class='form-control selectpicker' title='AAA'
                                name='adicionarColaboradorMudanca' required='required'>";
...
while (mysqli_stmt_fetch($stmt)) {
    ...
    if($idColaborador == $refIdColaborador){echo "selected";}
...
echo "</select>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-2'>
                                ...
                                id='inputEmail' name='dataMudanca' data-mask='99-99-9999'
                                placeholder='Data da Mudança' ";
        if(!empty($dataMudanca)){
            $conversaoDataConsultaMedicina = new DateTime($dataMudanca);
        ...
        echo " >
                            ...
                            <div class='col-sm-1'>
                            <label for='inputEmail' class='control-label'>Medida</label>
                            </div>
                            <div class='col-sm-3'>
                                <textarea placeholder='Medida da Mudança' rows='2' class='form-control'
                                name='medidaMudanca'>";if(!empty($medidaMudanca)){
            echo $medidaMudanca;        } echo "</textarea>
                            </div>

                             <div class='col-sm-1'>
                            <label for='inputEmail' class='control-label'>Causa</label>
                            </div>
                            <div class='col-sm-3'>
                                <textarea placeholder='Causa da Mudança' rows='2' class='form-control'
                                name='causaMudanca'>";if(!empty($causaMudanca)){
            echo $causaMudanca;
        } echo "</textarea>
                            </div>
                            ...
                            <label for='input-text' class='col-sm-2 control-label'>Nova Função</label>
                            <div class='col-sm-2'>
                                 <select id='pessoasDecisao' class='form-control' name='";
        if(($funcaoMudanca != "Distribuição") AND ($funcaoMudanca != "Escritório") AND ($funcaoMudanca != "Técnico de Vendas")
            AND ($funcaoMudanca != "Ajudante")){}else{echo "funcaoMudanca";}

        echo "' onchange='apresentacaInputTexto();'>
                                                <option selected disabled>Função</option>
                                                <option ";
        if($funcaoMudanca == "Ajudante"){
            echo "selected";
        }
        echo " value='Ajudante'><b>Ajudante</b></option>
                                                <option ";
        if($funcaoMudanca == "Distribuição"){
            echo "selected";
        }
        echo " value='Distribuição'><b>Distribuição</b></option>
                                                <option ";
        if($funcaoMudanca == "Escritório"){
            echo "selected";
        }
        echo " value='Escritório'><b>Escritório</b></option>
                                                <option ";
        if($funcaoMudanca == "Técnico de Vendas"){
            echo "selected";
        }
        echo " value='Técnico de Vendas'><b>Técnico de Vendas</b></option>
                                                <option ";
        if(($funcaoMudanca != "Distribuição") AND ($funcaoMudanca != "Escritório") AND ($funcaoMudanca != "Técnico de Vendas")
        AND ($funcaoMudanca != "Ajudante")){
            echo "selected";
        }
        echo " value='Outro'><b>Outro</b></option>
                                    ...
                                    <div id='outroPessoasDecisao' ";

        if(($funcaoMudanca != "Distribuição") AND ($funcaoMudanca != "Escritório") AND ($funcaoMudanca != "Técnico de Vendas")
            AND ($funcaoMudanca != "Ajudante")){echo "style='display: block'";}else{echo "style='display: none'";}


        echo " ><label for='input-text' class='col-sm-1'>Qual?</label>
                                                <div class='col-sm-2'>
                                             <input name='";
        if(($funcaoMudanca != "Distribuição") AND ($funcaoMudanca != "Escritório") AND ($funcaoMudanca != "Técnico de Vendas")
            AND ($funcaoMudanca != "Ajudante")){echo "funcaoMudanca";}else{}
        echo"' type='text' class='form-control' id='idPessoasDecisao' ";
        if(($funcaoMudanca != "Distribuição") AND ($funcaoMudanca != "Escritório") AND ($funcaoMudanca != "Técnico de Vendas")
            AND ($funcaoMudanca != "Ajudante")){echo "value='$funcaoMudanca'";}else{}
        echo " ></div></div>
                                    <script>
                                        function apresentacaInputTexto(){
                                            ...
                                            if(document.getElementById('pessoasDecisao').value == 'Outro'){
                                                ...
                                                $('#idPessoasDecisao').attr('name', 'funcaoMudanca');

                                            }else{

                                                document.getElementById('outroPessoasDecisao').style.display='none';
                                                $('#pessoasDecisao').attr('name', 'funcaoMudanca');
                            ...
                            <label for='input-text' class='col-sm-1 control-label'>Novo Vencim.</label>
                            <div class='col-sm-1'>
                                <input type='text' id='inputEmail' placeholder='Vencimento' data-mask='999.99€'
                                autocomplete='on' class='form-control' name='novoVencimentoMudanca' ";
        if(!empty($vencimentoMudanca)){
            echo "value='$vencimentoMudanca&euro;'";
        }
        echo " ></div>
                            <label for='input-text' class='col-sm-2 control-label'>Período de Experiência (dias)</label>
                                 <div class='col-sm-1'>
                              <input type='number' id='inputEmail' placeholder='Dias'
                                autocomplete='on' class='form-control' name='experienciaMudanca' ";
        if(!empty($periodoExperienciaMudanca)){
            echo "value='$periodoExperienciaMudanca'";
        }
        echo " ></div>
                            ...
                            <div class='col-sm-2'>
                            <label for='inputEmail' class='control-label'>Medida Eficaz?&nbsp;&nbsp;</label>
                                            <label>
                                                <input type='radio' id='optionsRadios1' ";
        if($eficaciaMudanca == "Sim"){
            echo "checked";
        }
                                                       echo " value='Sim' name='eficaciaMudanca'> &nbsp;Sim &nbsp;&nbsp;&nbsp;
                                            </label>
                                            <label>
                                                <input type='radio' name='eficaciaMudanca' ";
        if($eficaciaMudanca == "Não"){
            echo "checked";
        }
                             ...
                             <div class='col-sm-1'>
                            <label for='inputEmail' class='control-label'>Comentários</label>
                            </div>
                            <div class='col-sm-4'>
                                <textarea rows='2' placeholder='Comentários da Mudança' class='form-control'
                                name='comentarioMudanca'>";
        if(!empty($comentariosMudanca)){
            echo $comentariosMudanca;
        }
            echo "</textarea>
                            </div>
