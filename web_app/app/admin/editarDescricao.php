...
if (!isset($_SESSION['ativoAdmin'])) {
    ...
    <div class='md-modal md-just-me' id='logout-modal'>
        <div class='md-content'>
            ...
            <div>
                <p class='text-center'>Tem a certeza que pretende abandonar a Plataforma de Gestão dos Recursos Humanos
                    da
                    Bento & Nascimento?</p>
    ...
    <div class='page-heading'>
        ...
        <h3>Edite a descrição de uma função, preenchendo os dados requisitados</h3></div>
    <!-- Page Heading End-->
    <div class='row'>
        <div class='col-md-12'>";
            ...
            if (isset($_GET['sucesso'])) {
               ...
               A descrição da função <b>$nomeFuncao</b> foi editada com sucesso.<br>
            ...
            if (isset($_GET['erro'])) {
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao editar a descrição da função <b>$nomeFuncao</b>.<br>
...
WHERE id_descricao = ?";
        ...
        mysqli_stmt_close($stmt);
            ...
            echo "<div class='widget animated fadeInDown'>
                <form id='myWizard' action='php/verificacoes/verificaEditarDescricao.php?descricao=$idDescricao' method='post'>
        ...
        if(!empty($tituloDescricao)) {
            echo "value='$tituloDescricao'";
            }

        echo " placeholder='Título da Função' autocomplete='on' required='required' class='form-control'>
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea name='objetivoDefinicao' rows='5'
                                              ...
                                              class='form-control'>";
        if(!empty($objetivoDescricao)) {
            echo "$objetivoDescricao";
        }
        echo "</textarea>
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea name='enquadramentoDefinicao' rows='5'
                                              ...
                                              class='form-control'>";
        if(!empty($enquadramentoDescricao)) {
            echo "$enquadramentoDescricao";
        }
        echo "</textarea>
                                </div>
                            </div>
    ...
    color: #5b5b5b !important;'>Manipule os conteúdos que pretende inserir com total liberdade.
                                ...
                                <div class='widget-content'>
                                    <textarea rows='20' id='ckeditor' name='conteudoDescricao'
                                              placeholder='Introduza e manipule os seus conteudos'>";
        if(!empty($conteudoDescricao)) {
            echo "$conteudoDescricao";
        }
                                echo "</textarea>
                                </div>
                                <style>
                    ...
                    <section class='step' data-step-title='Competências'>
                        <div class='row'>
                            ...
                            <div class='widget'>
                                ...
                                <div class='widget-content'>
                                    <textarea rows='20' id='t1' name='tecnicasDescricao'>";
        if(!empty($competenciasTecnicasDescricao)){
            echo "$competenciasTecnicasDescricao";
        }
                        echo "</textarea>
                                </div>
                            </div>
                            ...
                            <div class='widget'>
                                ...
                                <div class='widget-content'>
                                    <textarea rows='20' id='t2' name='comportamentaisDescricao'>";
        if(!empty($competenciasComportamentaisDescricao)){
            echo "$competenciasComportamentaisDescricao";
        }echo "</textarea>
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea name='requisitosDefinicao' rows='4'
                                              ...
                                              class='form-control'>";
        if(!empty($resquisitosDescricao)) {
            echo "$resquisitosDescricao";
        }echo "</textarea>
                                </div>
                            </div>
        ...
        if(!empty($substitutosDescricao)) {
            echo "value='$substitutosDescricao'";
        }
        echo " >
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea name='fisicasMateriaisDefinicao' rows='4'
                                              ...
                                              class='form-control'>";
        if(!empty($condicoesDescricao)) {
            echo "$condicoesDescricao";
        }echo "</textarea>
                                </div>
                            </div>
                            ...
                            <div class='col-sm-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea name='contrapartidasDefinicao' rows='4'
                                              ...
                                              class='form-control'>";
        if(!empty($contrapartidasDescricao)) {
            echo "$contrapartidasDescricao";}
            echo "</textarea>
                                </div>
                            </div>
