...
Menus('comunicacoes', 'comunicacaoMarcacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                  <h1><i class='fa fa-comments'></i> Comunicações - Marcação Medicina de Trabalho</h1>

                <h3>Selecione a marcação que deseja ver impressa para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoMarcacao.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> Marcação de Medicina de Trabalho</h2>
        ...
        echo "<tr>
                                            ...
                                            <td style='display: none'></td>
                                                ...
                                                <div class='btn-group btn-group-xs text-center'>
                                                    <a href='imprimirMarcacaoDetalhes.php?colaborador=$idColaborador&marcacao=$idMarcacao'
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Marcação de Medicina de Trabalho - <strong>$apresentaNomeFormacoes</strong></h2>
...
colaborador.id_colaborador, colaborador.ativo FROM marcacao_consulta
INNER JOIN colaborador ON colaborador.id_colaborador = marcacao_consulta.ref_id_colaborador
WHERE colaborador.ativo = 1 AND coloaborador.id_colaborador = ? ORDER BY colaborador.nome_completo ASC ";
