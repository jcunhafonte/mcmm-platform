...
Menus('comunicacoes', 'comunicacaoFerias');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                    <h1><i class='fa fa-comments'></i> Comunicações - Férias</h1>

                <h3>Selecione as férias que deseja ver impressa para apresentar ao seu colaborador</h3></div>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>Todos os Colaboradores</strong></h2>
        ...
        echo "</td>
                                               <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                            <a href='imprimirFeriasDetalhes.php?ferias=$idFerias&colaborador=$idColaborador' data-toggle='tooltip' title='Ver Comunicação'
...
if ((!isset($_GET['mesFerias'])) AND (!isset($_GET['anoFerias']))
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Férias</h2>
...
if ((isset($_GET['mesFerias'])) AND (isset($_GET['anoFerias'])) AND (!isset($_GET['colaboradorFerias']))) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis</h2>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>$apresentaNomeFormacoes</strong></h2>
