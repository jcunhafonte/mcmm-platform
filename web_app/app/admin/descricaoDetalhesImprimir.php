...
echo "<div class='row'>
					<div class='col-sm-12' id='contentA'>
					<br>
						<div class='widget'>
							<div class='widget-header' style='background: none; border-bottom: none;'>
								<h2 id='titulo$idDescricao' style='font-size: 30px !important;'>Descrição da Função - $tituloDescricao</h2>
							...
							<div class='widget-content padding'>
								...
								<div class='col-sm-6'>
								<h3>Descrição</h3>
										<h4 href='#demo1-home' data-toggle='tab'>Objetivo</h4>
								...
								<div class='col-sm-6'>
								<h3>&nbsp;</h3>
										<h4 href='#demo1-profile' data-toggle='tab'>Enquadramento Orgânico</h4>

								<div class='tab-content'>
									<div class='tab-pane fade active in' id='demo1-profile'>
...
<div class='col-sm-3'>
										...
										<h4 href='#demo6-home' data-toggle='tab'>Requisitos Mínimos</h4>
...
<div class='col-sm-3'>
										...
										<h4 href='#demo7-profile' data-toggle='tab'>Substituto</h4>

								<div class='tab-content'>
									<div class='tab-pane fade active in' id='demo7-profile'>
...
<div class='col-sm-3'>
										<h4 href='#demo8-profile' data-toggle='tab'>Condições Físicas e Materiais</h4>

								<div class='tab-content'>
                                    <div class='tab-pane fade active in' id='demo8-profile'>
										<p>$condicoesDescricao</p>
                                    </div> <!-- / .tab-pane -->
								</div> <!-- / .tab-content -->
</div>
<div class='col-sm-3'>
										<h4 href='#demo9-profile' data-toggle='tab'>Contrapartidas Remuneratórias</h4>

								<div class='tab-content'>
                                       <div class='tab-pane fade active in ' id='demo9-profile'>
