...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-users'></i> Utilizadores Ativos</h1>

                <h3>Verifique os utilizadores ativos, desative ou edite dados</h3></div>
               ...
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Utilizadores</strong> Ativos</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-3" class="table table-striped table-bordered" cellspacing="0"
                                      ...
                                      data_registo, ultima_visita, num_visitas, idade, funcao FROM utilizadores
                                      WHERE ativo = ? ORDER BY nome_utilizador ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $ativo);
                                        mysqli_stmt_bind_result($stmt, $idUtilizador, $nomeUtilizador, $email, $dataRegisto, $dataUltimaVisita, $numVisitas, $idade, $funcao);
                                        mysqli_stmt_execute($stmt);
                                            ...
                                            */
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    ...
                                                    <a data-href='php/verificacoes/verificaDesativarUtilizador.php?utilizador=$idUtilizador' data-toggle='tooltip' title='Desativar Utilizador' class='text-center btn btn-default md-trigger' id='botaoRemover$idUtilizador' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' onclick='modalRemover($idUtilizador);'><i class='fa fa-user-times'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
