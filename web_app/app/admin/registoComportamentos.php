...
Menus('comportamentos', 'visualizarComportamento');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                ...
                <h3>Verifique os comportamentos já registados aos seus colaboradores</h3></div>
...
if (isset($_GET['comportamentoRemovido'])) {

    $colaboradorRemovido = $_GET['comportamentoRemovido'];
...
if (isset($_GET['comportamentoRemovidoErro'])) {

    $colaboradorRemovido = $_GET['comportamentoRemovidoErro'];
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoComportamentos.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Comportamentos</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td><a href='perfilColaborador.php?colaborador=$refIdColaborador'><span id='titulo$idComportamento'>$nomeComportamento</span></a></td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='registoComportamentoDetalhes.php?colaborador=$refIdColaborador&comportamento=$idComportamento' data-toggle='tooltip' title='Ver Detalhes'
                                                       class='text-center btn btn-default'><i class='fa fa-eye'></i></a>

                                                        <a href='editarComportamento.php?comportamento=$idComportamento' data-toggle='tooltip' title='Editar Comportamento'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>

                                                <a data-href='php/verificacoes/verificaCancelarComportamento.php?colaborador=$refIdColaborador&comportamento=$idComportamento'
                                                    data-toggle='tooltip' title='Remover Comportamento'
                                                    class='md-trigger text-center btn btn-default'
                                                      onclick='modalRemover($idComportamento);' id='botaoRemover$idComportamento'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Comportamentos - <strong>$nomeCompletoApresenta</strong></h2>
