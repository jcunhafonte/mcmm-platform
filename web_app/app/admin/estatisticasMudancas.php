...
Menus('estatisticas', 'estatisticasMudancas');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Mudanças de Função</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de mudanças de função por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Número de mudanças de função ano</h2>
...
$query = "SELECT YEAR( data_mudanca ), COUNT( id_mudanca )
FROM mudancas WHERE YEAR( data_mudanca ) = ?";
