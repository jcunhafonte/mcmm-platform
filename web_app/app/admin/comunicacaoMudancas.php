...
Menus('comunicacoes', 'comunicacaoMudancas');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-comments'></i> Comunicações - Mudanças de Função</h1>

                <h3>Selecione a comunicação que deseja ver impressa para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoMudancas.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Mudança de Função</h2>
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='imprimirMudancaDetalhes.php?colaborador=$refIdColaborador&mudanca=$idMudanca'
                                                data-toggle='tooltip' title='Ver Comunicação'
                                                class='text-center btn btn-default'><i class='fa fa-comment'></i></a>
