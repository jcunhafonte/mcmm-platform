...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Marcações Medicina de Trabalho</title>
...
Menus('exportarDados', 'qualidadeMarcacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
               <h1><i class='fa fa-table'></i> Exportar Dados - Marcações Medicina de Trabalho</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosMarcacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Marcações Medicina de Trabalho</strong></h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td><span id='titulo$idMarcacao'>$nomeCompletoColaborador</span></td>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>Marcação Medicina de Trabalho</strong></h3>
                                            </td>
                                            </tr>
                                </table>";
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$nomeCompletoColaborador</td>
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$tipoConsultaMarcacao</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$textoDataConsultaMedicina</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Marcação Medicina de Trabalho</strong> - <strong>$nomeCompletoApresenta</strong></h2>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td width='70%'>
                                            <h3><strong>Marcações Medicina de Trabalho</strong> - <strong>$nomeCompletoApresenta</strong></h3>
                                            </td>
                                            </tr>
                                </table>";
