...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Férias</title>
...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Cancelar Férias</h3>

        <div>
            <p>Tem a certeza que pretende cancelar estas férias do colaborador <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação não pode ser revertida.
                </li>
               <li><strong>Informação:</strong> Após a confirmação da remoção, pode voltar a adicionar férias ao colaborador.
                </li>
...
Menus('exportarDados', 'qualidadeFerias');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
           ...
           <div class='page-heading'>
               <h1><i class='fa fa-table'></i> Exportar Dados - Férias</h1>
...
if (isset($_GET['feriasRemovidas'])) {

    $colaboradorRemovido = $_GET['feriasRemovidas'];
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               As férias do colaborador <b>$nomeCompletoRemovido</b> foram canceladas com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

if (isset($_GET['feriasRemovidasErro'])) {

    $colaboradorRemovido = $_GET['feriasRemovidasErro'];
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao cancelar as férias do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}
...
echo "<div class='widget col-sm-12'>
                        ...
                        <div class='widget-content padding'>
                            <form class='form-horizontal' role='form' method='get'
                                  action='exportarDadosFerias.php'>
                        ...
                        <select class='form-control selectpicker'
                                name='mesFerias' required='required'>
...
for ($mes = 1; $mes <= 12; $mes++) {
    ...
    echo "<option ";
    if (isset($_GET['mesFerias'])) {
        if ($mes == $_GET['mesFerias']) {
            echo "selected";
        }
    }
    echo " name='mesFerias' value='$mes'>";
...
echo "</select>
                        ...
                        <select class='form-control selectpicker'
                                name='anoFerias' required='required'>
                                <option disabled selected value=''>Ano</option>";

for ($ano = 2013; $ano <= date('Y'); $ano++) {

    echo "<option ";
    if (isset($_GET['anoFerias'])) {
        if ($ano == $_GET['anoFerias']) {
            echo "selected";
        }
    }
    echo " name='anoFerias' value='$ano'>";
    echo $ano;
    echo "</option>";
...
echo "</select>
                        ...
                        <select class='form-control selectpicker' name='colaboradorFerias'>
...
while (mysqli_stmt_fetch($stmt)) {
    ...
    if (isset($_GET['colaboradorFerias'])) {
        if ($idColaborador == $_GET['colaboradorFerias']) {
            echo "selected";
        }
    }
...
if ((isset($_GET['mesFerias'])) AND (isset($_GET['anoFerias'])) AND (isset($_GET['colaboradorFerias']))
    AND ($_GET['colaboradorFerias'] == 0)) {

    $mes = $_GET['mesFerias'];
    $ano = $_GET['anoFerias'];
    $colaborador = $_GET['colaboradorFerias'];
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt, 'i', $_GET['colaboradorFerias']);
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis -
                            <strong>Todos os Colaboradores</strong></h2>
...
ferias.fim_ferias, ferias.ref_id_colaborador, colaborador.nome_completo,
colaborador.id_colaborador, colaborador.ativo, colaborador.funcao FROM ferias
INNER JOIN colaborador ON colaborador.id_colaborador = ferias.ref_id_colaborador
WHERE (colaborador.ativo = 1)
AND (MONTH( ferias.inicio_ferias ) = ?)
AND (YEAR(ferias.inicio_ferias) = ?)
GROUP BY ferias.ref_id_colaborador
ORDER BY colaborador.nome_completo ASC";
    ...
    mysqli_stmt_bind_result($stmt, $idFerias, $inicioFerias, $fimFerias, $refColaboradorFerias,
        $nomeCompletoColaborador, $idColaborador, $ativoColaborador, $funcaoColaborador);
    mysqli_stmt_execute($stmt);
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td><span id='titulo$idFerias'>$nomeCompletoColaborador</span></td>
                                            <td>$funcaoColaborador</td>
                                            <td>$textoDataConsultaFerias</td>
                                            <td>$textoDataConsultaFeriasFim</td>
                                            <td>";
        if($nr_work_days == 1){
            echo "$nr_work_days dia";
        }else{
            echo "$nr_work_days dias";
        }
        echo "</td>
                                        </tr>";
    }
                            ...
                            <div class='table-responsive' style='overflow-x: hidden' id='contentA'>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                            <td>";     $nr_work_days = getWorkingDays($beginday, $lastday); echo "
                                          <h3><strong>Férias</strong> - <strong>$mes_extenso[$mes] de $ano
...
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <span id='titulo$idFerias'>$nomeCompletoColaborador</span></td>
                                            <td style='text-align: center !important;'>$funcaoColaborador</td>
                                            <td style='text-align: center !important;'>$textoDataConsultaFerias</td>
                                            <td style='text-align: center !important;'>$textoDataConsultaFeriasFim</td>
                                            <td style='text-align: center !important;'>";
        if($nr_work_days == 1){
            echo "$nr_work_days dia";
        }else{
...
if ((!isset($_GET['mesFerias'])) AND (!isset($_GET['anoFerias']))
    AND (!isset($_GET['colaboradorFerias']))){

    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Férias</strong></h2>
...
if ((isset($_GET['mesFerias'])) AND (isset($_GET['anoFerias'])) AND (!isset($_GET['colaboradorFerias']))) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Férias</strong> - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis</h2>
                            ...
                            <div class='table-responsive' style='overflow-x: hidden' id='contentA'>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                            <td>";     $nr_work_days = getWorkingDays($beginday, $lastday); echo "
                                          <h3><strong>Férias</strong> - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis
...
if ((isset($_GET['mesFerias'])) AND (isset($_GET['anoFerias'])) AND (isset($_GET['colaboradorFerias'])) AND ($_GET['colaboradorFerias'] != 0)) {
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Férias</strong> - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>$apresentaNomeFormacoes</strong></h2>
                            ...
                            <div class='table-responsive' style='overflow-x: hidden' id='contentA'>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <td>";     $nr_work_days = getWorkingDays($beginday, $lastday); echo "
                                          <h3><strong>Férias</strong> - <strong>$mes_extenso[$mes] de $ano
                                          </strong> - $nr_work_days Dias Úteis - <strong>$apresentaNomeFormacoes</strong>
                                          </h3>
