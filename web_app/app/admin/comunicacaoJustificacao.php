...
Menus('comunicacoes', 'comunicacaoJustificacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                   <h1><i class='fa fa-comments'></i> Comunicações - Justificações</h1>

                <h3>Selecione a justificação que deseja ver impressa para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoJustificacao.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Justificações</h2>
...
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "</td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='imprimirJustificacaoDetalhes.php?colaborador=$refIdColaborador&justificacao=$idJustificacao'
                                                    data-toggle='tooltip' title='Ver Comunicação' class='text-center btn btn-default'>
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Justificações - <strong>$nomeCompletoApresenta</strong></h2>
