...
Menus('comunicacoes', 'comunicacaoComportamento');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
               <h1><i class='fa fa-comments'></i> Comunicações - Comportamentos Não Aceitáveis</h1>

                <h3>Selecione o comportamento que deseja ver impresso para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoComportamentos.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Comportamentos Não Aceitáveis</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='imprimirComportamentoDetalhes.php?colaborador=$refIdColaborador&comportamento=$idComportamento'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Comportamentos Não Aceitáveis - <strong>$nomeCompletoApresenta</strong></h2>
