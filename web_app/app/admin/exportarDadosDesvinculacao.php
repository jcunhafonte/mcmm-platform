...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Entrevistas de Desvinculação</title>
...
Menus('exportarDados', 'qualidadeDesvinculacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                 <h1><i class='fa fa-table'></i> Exportar Dados - Entrevistas de Desvinculação</h1>

                <h3>Visualize, consulte e exporte os dados das suas entrevistas de desvinculação para diversos formatos</h3>
            <div class='row'>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosDesvinculacao.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Entrevistas de Desvinculação</strong></h2>
 ...
 ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <td>$textoNovaDataEntrevistaDesvinculacao</td>
                                            <td>$textoNovaDataDesvinculacao";
        echo "</td>
                                            <td>$motivoDesvinculacao</td>
                                            <td>$melhoriaDesvinculacao</td>
                                             <td>$comentariosDesvinculacao</td>
                                             <td>$parecerDesvinculacao</td>
                                                <td>"; echo $readmitidoDesvinculacao; echo ". "; echo "$porqueDesvinculacao</td>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>Entrevistas de Desvinculação</strong></h3>
                                            </td>
                                            </tr>
                                </table>";


    $query = "SELECT desvinculacao.id_desvinculacao, colaborador.nome_completo, colaborador.ativo
FROM desvinculacao INNER JOIN colaborador ON desvinculacao.ref_id_colaborador = colaborador.id_colaborador
ORDER BY colaborador.nome_completo ASC ";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_result($stmt, $idDesvinculacao2, $nomeComportamento, $ativoComportamento);
    mysqli_stmt_execute($stmt);
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        $query2 = "SELECT desvinculacao.id_desvinculacao, desvinculacao.ref_id_colaborador, desvinculacao.data_entrevista,
desvinculacao.porque, desvinculacao.data_desvinculacao, desvinculacao.motivo, desvinculacao.novamente, desvinculacao.melhorar,
desvinculacao.relacionamento, desvinculacao.estrutura, desvinculacao.valores, desvinculacao.planeamento, desvinculacao.superior,
desvinculacao.gerencia, desvinculacao.contrapartidas, desvinculacao.funcao, desvinculacao.comentarios, desvinculacao.parecer,
desvinculacao.readmissao, colaborador.nome_completo FROM desvinculacao
...
WHERE desvinculacao.id_desvinculacao = ? ORDER BY colaborador.nome_completo ASC";
        ...
        mysqli_stmt_bind_param($stmt2, 's', $idDesvinculacao2);
        mysqli_stmt_bind_result($stmt2, $idDesvinculacao, $refIdColaborador, $novaDataEntrevistaDesvinculacao, $porqueDesvinculacao,
            $novaDataDesvinculacao, $motivoDesvinculacao, $trabalhariaDesvinculacao, $melhoriaDesvinculacao,
            $relacionamentoInterpessoalDesvinculacao, $estruturaFisicaDesvinculacao, $valoresNormasEmpresa, $planeamentoOrganizacaoObjetivos,
            $superiorHierarquico, $gerenciaDesvinculacao, $contrapartidasEmpresa, $funcaoExercida, $comentariosDesvinculacao,
            $parecerDesvinculacao, $readmitidoDesvinculacao, $nomeColaborador);
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$nomeColaborador</td>
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$textoNovaDataEntrevistaDesvinculacao</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$textoNovaDataDesvinculacao</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$motivoDesvinculacao</td>
                                        <td style='border-bottom: none !important; text-align: center !important;'>$melhoriaDesvinculacao</td>
                                        </tr>";
...
WHERE desvinculacao.id_desvinculacao = ? ORDER BY colaborador.nome_completo ASC";
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$comentariosDesvinculacao</td>
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$parecerDesvinculacao</td>
                                           <td>"; echo $readmitidoDesvinculacao; echo ". "; echo "$porqueDesvinculacao</td>
                                                                                  </tr>";
        mysqli_stmt_close($stmt2);
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                            <div class='widget-header'>
                            <h2><strong>Entrevistas de Desvinculação</strong> - <strong>$apresentaNomeFormacoes</strong></h2>
...
desvinculacao.readmissao, colaborador.nome_completo FROM desvinculacao
INNER JOIN colaborador ON desvinculacao.ref_id_colaborador = colaborador.id_colaborador
WHERE desvinculacao.ref_id_colaborador = ? ORDER BY colaborador.nome_completo ASC";
