...
Menus('formacoes', 'registoFormacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-graduation-cap'></i> Formação</h1>

                <h3>Verifique as formação já realizadas pelos seus colaboradores</h3></div>
...
if (isset($_GET['formacaoRemovida'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A formação do colaborador <b>$nomeCompletoRemovido</b> foi removida com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

if (isset($_GET['formacaoRemovidaErro'])) {

    $colaboradorRemovido = $_GET['formacaoRemovidaErro'];
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao remover a formação do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoFormacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Formação</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        if ($duracaoFormacoes == 1) {
            $textoDuracaoFormacoes = "1 hora";
        } else {
            $textoDuracaoFormacoes = $duracaoFormacoes . " horas";
        }

        echo "<tr>
                                            <td><a href='perfilColaborador.php?colaborador=$refIdColaboradorFormacoes'>
                                            <span id='titulo$idFormacoes'>$nomeFormacoes</span></a></td>
                                            <td>";
        echo $anoFormacoes;
        echo "</td>
                                            <td>$descricaoFormacoes</td>
                                            <td>$textoDuracaoFormacoes</td>
                                            <td>";
        echo $entidadeFormacoes;
        echo "</td>
 <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                             <a href='editarFormacao.php?formacao=$idFormacoes' data-toggle='tooltip' title='Editar Formação'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>
                                                    <a data-href='php/verificacoes/verificaCancelarFormacao.php?colaborador=$idColaborador&formacao=$idFormacoes'
                                                    data-toggle='tooltip' title='Remover Formação'
                                                     onclick='modalRemover($idFormacoes);' id='botaoRemover$idFormacoes'
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Formação - <strong>$apresentaNomeFormacoes</strong></h2>
