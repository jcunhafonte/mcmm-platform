...
Menus('medicina', 'marcacaoConsultas');
...
if (isset($_GET['sucesso'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A consulta do colaborador <b>$nomeCompletoAdicionada</b> foi marcada com sucesso.<br>
...
if (isset($_GET['erro'])) {
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao marcar a consulta do colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Marcar</strong> Consulta</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaMarcacaoConsulta.php'>
                        <div class='form-group'>
...
echo "</select>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-10'>
                                ...
                                class='btn btn-default input-block-level'>Marcar</button>
                            </div>
