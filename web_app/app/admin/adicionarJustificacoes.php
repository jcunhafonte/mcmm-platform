...
Menus('justificacoes', 'justificarFalta');
...
if (isset($_GET['sucesso'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A justificação do colaborador <b>$nomeCompletoAdicionada</b> foi adicionada com sucesso.<br>
...
if (isset($_GET['erro'])) {
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao adicionar a justificação ao colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Adicionar</strong> Justificação</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaAdicionarJustificacao.php'>
                        <div class='form-group'>
...
echo "</select>
                        ...
                        <div class='form-group'>
                            ...
                            <label for='inputEmail' class='control-label'>Motivo</label>
                             ...
                             <div class='col-sm-3'>
                                    <input placeholder='Motivo da Justificação' name='adicionarMotivoJustificacao' type='text' class='form-control' id='input-text-has-success'>
                                </div>
                        </div>
