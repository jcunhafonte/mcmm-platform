...
Menus('estatisticas', 'estatisticasPresencas');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Presenças</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de presenças por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Número de presenças por ano</h2>
...
$query = "SELECT COUNT(presencas.id_presencas) FROM presencas
WHERE (YEAR(presencas.data_presenca) = ?)";

$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_param($stmt, 'i', $inicioDataAdmissao);
mysqli_stmt_bind_result($stmt, $anoAju);
mysqli_stmt_execute($stmt);
mysqli_stmt_fetch($stmt);
mysqli_stmt_close($stmt);

echo "{ y: '$inicioDataAdmissao', a: $anoAju},";
