        ...
        <div class='content'>
            <!-- Page Heading Start -->
             <div class='page-heading'>
                <h1 style='float: left!important;'><i class='fa fa-fa fa-plane'></i> Férias</h1>
<span style='display: none !important;' id='titulo$refColaboradorFerias'>$nomeCompletoColaborador</span>
                  <div class='text-right' style='height: 73px !important; padding-top: 15px !important;'>
								<div class='row text-right'>
									<div class='col-lg-4 text-right' style='float: right!important;'>
                                        <a
                                        data-href='php/verificacoes/verificaCancelarFerias.php?colaborador=$refColaboradorFerias&ferias=$idFerias'
                                        onclick='modalRemover($refColaboradorFerias);' id='botaoRemover$refColaboradorFerias'
										...
										<i class='fa fa-remove'></i> Cancelar Férias</button></a>
        ...
        if (isset($_GET['sucesso'])) {
            ...
            echo "<div class='alert alert-success alert-dismissable'>
               ...
               As férias do colaborador <b>$nomeCompletoAdicionada</b> foram editadas com sucesso.<br>
        ...
        if (isset($_GET['erro'])) {
            ...
            echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao editar as férias ao colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
        }

        echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Editar</strong> Férias</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaEditarFerias.php?ferias=$idFerias'>
                        <div class='form-group'>
        ...
        $stmt = mysqli_prepare($link, $query);
        mysqli_stmt_bind_result($stmt, $idColaborador, $nomeCompletoColaborador);
        mysqli_stmt_execute($stmt);

        while (mysqli_stmt_fetch($stmt)) {
            echo "<option value='$idColaborador' ";
            if ($idColaborador == $refColaboradorFerias) {
                echo "selected";
            }
            echo " >
                                $nomeCompletoColaborador</option>";
        }
        mysqli_stmt_close($stmt);
        ...
        echo "</select>
                            ...
                            <div class='col-sm-2'>
                               ...
                               <span id='feriasColaboradorA'>Faça as suas alterações</span>
        ...
        if (isset($inicioFerias)) {

            echo "value='$textoDataConsultaFerias'";
        ...
        if (isset($fimFerias)) {
            ...
            echo "value='$textoDataConsultaFeriasFim'";
