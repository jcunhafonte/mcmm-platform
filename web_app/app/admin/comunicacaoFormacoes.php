...
Menus('comunicacoes', 'comunicacaoFormacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                  <h1><i class='fa fa-comments'></i> Comunicações - Formação</h1>

                <h3>Selecione a formação que deseja ver impressa para apresentar ao seu colaborador</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoFormacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Formação</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
 ...
 <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    <a href='imprimirFormacaoDetalhes.php?colaborador=$idColaborador&formacao=$idFormacoes'
                                                    data-toggle='tooltip' title='Ver Comunicação' id='botaoRemover$idFormacoes'
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Comunicação de Formação - <strong>$apresentaNomeFormacoes</strong></h2>
