...
Menus('medicina', 'registoMarcacoes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-stethoscope'></i> Medicina de Trabalho</h1>

                <h3>Verifique as consultas marcadas aos seus colaboradores</h3></div>
...
if (isset($_GET['marcacaoRemovida'])) {

    $colaboradorRemovido = $_GET['marcacaoRemovida'];
...
if (isset($_GET['marcacaoRemovidaErro'])) {

    $colaboradorRemovido = $_GET['marcacaoRemovidaErro'];
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoMarcacoes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Marcações de Consultas</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_result($stmt, $idMarcacao, $tipoConsultaMarcacao,$dataConsultaMarcacao, $refColaboradorMarcacao,
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <span id='titulo$idMarcacao'>$nomeCompletoColaborador</span></a></td>
                                            <td>$tipoConsultaMarcacao</td>
                                            <td>$textoDataConsultaMedicina</td>
                                            <td style='display: none'></td>
                                            <td style='display: none'></td>
                                               <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                            <a href='editarMarcacao.php?marcacao=$idMarcacao' data-toggle='tooltip' title='Editar Marcação'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>
                                                    <a data-href='php/verificacoes/verificaCancelarMarcacao.php?colaborador=$idColaborador&marcacao=$idMarcacao'
                                                    data-toggle='tooltip' title='Remover Marcação'
                                                     onclick='modalRemover($idMarcacao);'

id='botaoRemover$idMarcacao'
 data-target='#md-fade-in-scale-up'
  data-modal='md-fade-in-scale-up'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Marcações de Consultas - <strong>$nomeCompletoApresenta</strong></h2>
...
colaborador.id_colaborador, colaborador.ativo FROM marcacao_consulta
INNER JOIN colaborador ON colaborador.id_colaborador = marcacao_consulta.ref_id_colaborador
WHERE colaborador.ativo = 1 AND marcacao_consulta.ref_id_colaborador = ? ORDER BY colaborador.nome_completo ASC ";
