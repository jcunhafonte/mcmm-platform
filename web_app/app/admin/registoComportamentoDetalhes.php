    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-exclamation-triangle'></i> Detalhes do Comportamento</h1>
                ...
                <div class='text-right' style='height: 43px !important; padding-top: 8px !important;'>
								<div class='row text-right'>
									<div class='col-lg-4 text-right' style='float: right!important;'>
										   ...
										   <a href='editarComportamento.php?comportamento=$idComportamento'>
                                        <button type='button' class='text-right btn btn-primary btn-sm'>
										<i class='fa fa-pencil-square-o'></i> Editar Comportamento</button></a>

										   <a
                                        data-href='php/verificacoes/verificaCancelarComportamento.php?colaborador=$refIdColaborador&comportamento=$idComportamento'
                                        onclick='modalRemover($idComportamento);'
                                                    id='botaoRemover$idComportamento'
...
echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong id='titulo$idComportamento'>$nomeApresenta</strong> - $textoDataComportamento</h2>
                            ...
                            <table id='user' class='table table-bordered table-striped' style='clear: both'>
                                <tbody>
                                 <thead>
                                        <tr>
                                            <th>Descrição</th>
                                             <th>Danos na Empresa</th>
                                             <th>Situação Recorrente e/ou Grave</th>
                                             <th>Análise das Causas</th>
                                               <th>Pessoas a Envolver</th>
                                        </tr>
                                        </thead>
                                            <td width='30%'>$descricaoComportamento</td>
                                             <td width='12%'>$danosComportamento</td>
                                                <td width='16%'>$situacaoComportamento</td>
                                             <td width='23%'>$analiseComportamento</td>
                                               <td width='19%'>$pessoasComportamento</td>
                                      </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                 <thead>
                                        <tr>
                                            ...
                                            <td width='10%'>$sancaoComportamento</td>
                                             <td width='53%'>$comentariosComportamento</td>
                                             <td width='12%'>$melhoriaComportamento</td>
                                               <td width='15%'>$documentosComportamento</td>
                                      </tr>
                                </tbody>
                            </table>
                        </div>
