...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Mudanças de Função</title>
...
Menus('exportarDados', 'qualidadeMudancas');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                  <h1><i class='fa fa-table'></i> Exportar Dados - Mudanças de Função</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosMudancas.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Mudanças de Função</strong></h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        if($eficaciaMudanca == "Sim"){
            $eficaciaMudanca = "Medida Eficaz";
        }else{
            $eficaciaMudanca = "Medida Não Eficaz";
        }
        ...
        echo "<tr>
                                            ...
                                            <td>$periodoExperienciaMudanca dias</td>
                                            <td>$eficaciaMudanca</td>
                                            <td>$comentariosMudanca</td>
                                            <td>$historicoFuncaoMudanca</td>
                                                  <td>"; echo $historicoVencimentoMudanca; echo "€</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>Mudanças de Função</strong></h3>
                                            </td>
                                            </tr>
                                </table>";

    $query = "SELECT mudancas.id_mudanca, colaborador.nome_completo, colaborador.ativo
FROM mudancas INNER JOIN colaborador ON mudancas.ref_id_colaborador = colaborador.id_colaborador
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_result($stmt, $idMudanca2, $nomeComportamento, $ativoComportamento);
    mysqli_stmt_execute($stmt);
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        $query2 = "SELECT mudancas.id_mudanca, mudancas.ref_id_colaborador, mudancas.data_mudanca, mudancas.medida,
mudancas.causa, mudancas.funcao, mudancas.vencimento, mudancas.periodo_experiencia, mudancas.eficacia,
mudancas.comentarios, mudancas.historico_vencimento, mudancas.historico_funcao, colaborador.nome_completo,
colaborador.ativo FROM mudancas INNER JOIN colaborador ON mudancas.ref_id_colaborador = colaborador.id_colaborador
WHERE colaborador.ativo = 1 AND mudancas.id_mudanca = ? ORDER BY colaborador.nome_completo ASC";
        ...
        mysqli_stmt_bind_param($stmt2, 's', $idMudanca2);
        mysqli_stmt_bind_result($stmt2, $idMudanca, $refIdColaborador, $dataMudanca, $medidaMudanca,
            $causaMudanca, $funcaoMudanca, $vencimentoMudanca, $periodoExperienciaMudanca, $eficaciaMudanca,
            $comentariosMudanca, $historicoVencimentoMudanca, $historicoFuncaoMudanca, $nomeMudanca, $ativoMudanca);
       ...
       mysqli_stmt_fetch($stmt2);
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$nomeMudanca</td>
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$textoDataMudanca</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$medidaMudanca</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$causaMudanca</td>
                                        </tr>";
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$funcaoMudanca</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>"; echo $vencimentoMudanca;
        echo"€</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$periodoExperienciaMudanca dias</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$eficaciaMudanca</td>
                                        </tr>";
        ...
        echo "<tr>
                                            <td style='text-align: center !important;'>$comentariosMudanca</td>
                                            <td style='text-align: center !important;'>$historicoFuncaoMudanca</td>
                                            <td style='text-align: center !important;'>"; echo $historicoVencimentoMudanca; echo"€</td>
                                        </tr>";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                             <h2><strong>Mudanças de Função</strong> - <strong>$nomeCompletoApresenta</strong></h2>
...
WHERE colaborador.ativo = 1 AND ref_id_colaborador = ? ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <td>$comentariosMudanca</td>
                                            <td>$historicoFuncaoMudanca</td>
                                                  <td>"; echo $historicVencimentoMudanca; echo "€</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>M. de Função</strong> - <strong>$nomeCompletoApresenta</strong></h3>
                                            </td>
                                            </tr>
                                </table>";
