...
if ((!isset($_SESSION['ativoAdmin']))) {
    ...
    if ((!isset($_GET['colaborador']) AND (!isset($_GET['comunicacao'])))) {
...
desvinculacao.readmissao, colaborador.ativo,
...
FROM desvinculacao INNER JOIN colaborador ON colaborador.id_colaborador = desvinculacao.ref_id_colaborador
...
mysqli_stmt_bind_result($stmt,
    $idDesvinculacao, $refIdColaborador, $novaDataEntrevistaDesvinculacao, $porqueDesvinculacao,
    ...
    $parecerDesvinculacao, $readmitidoDesvinculacao, $ativoColaborador,
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1 style='float: left !important;'><i class='fa fa-comments'></i> Comunicação - Entrevista de Desvinculação</h1>
...
if(!empty($telfColaborador) OR $telfColaborador != 0){
								...
								$textoNovaDataEntrevistaDesvinculacao</h3>
								</td>
								</tr>

<tr><td>&nbsp;</td></tr>";

if(!empty($novaDataDesvinculacao) AND ($novaDataDesvinculacao != "1970-01-01 00:00:00")){
    ...
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Data da Desvinculação</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$textoNovaDataDesvinculacao</h4>
...
if(!empty($motivoDesvinculacao)){
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Motivo</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$motivoDesvinculacao</h4>
...
if(!empty($trabalhariaDesvinculacao)){
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Trabalharia novamente na empresa? Porquê?</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$trabalhariaDesvinculacao</h4>
...
if(!empty($melhoriaDesvinculacao)){
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Na sua opinião, o que poderia melhorar?</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$melhoriaDesvinculacao</h4>

								</td>
								</tr>";
}

if(!empty($relacionamentoInterpessoalDesvinculacao)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Relacionamento Interpessoal</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$relacionamentoInterpessoalDesvinculacao</h4>

								</td>
								</tr>";
}

if(!empty($estruturaFisicaDesvinculacao)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Estrutura Física</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$estruturaFisicaDesvinculacao</h4>

								</td>
								</tr>";
}

if(!empty($valoresNormasEmpresa)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Valores e Normas da Empresa</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$valoresNormasEmpresa</h4>

								</td>
								</tr>";
}

if(!empty($planeamentoOrganizacaoObjetivos)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Planeamento, Organização e Objetivo</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$planeamentoOrganizacaoObjetivos";echo "</h4>

								</td>
								</tr>";
}

if(!empty($superiorHierarquico)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Superior Hierárquico</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$superiorHierarquico"; echo "</h4>

								</td>
								</tr>";
}

if(!empty($gerenciaDesvinculacao)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Gerência</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$gerenciaDesvinculacao</h4>

								</td>
								</tr>";
}

if(!empty($contrapartidasEmpresa)){

    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Contrapartidas Remuneratórias</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$contrapartidasEmpresa"; echo "</h4>

								</td>
								</tr>";
}

if(!empty($funcaoExercida)){
    echo "
								<tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>

	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Função Exercida</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$funcaoExercida</h4>
...
if(!empty($comentariosDesvinculacao)){
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important;'>$comentariosDesvinculacao</h4>
...
if((!empty($parecerDesvinculacao))){
    ...
    echo "
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Parecer do Entrevistador</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$parecerDesvinculacao";echo "</h4>
...
if((!empty($porqueDesvinculacao))){
    ...
    <tr>
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>O colaborador pode ser readmitido? Porquê?</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$readmitidoDesvinculacao"; echo ". "; echo "$porqueDesvinculacao";echo "</h4>
