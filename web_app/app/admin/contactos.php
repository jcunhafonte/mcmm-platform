...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        ...
        <div>
            <p>Tem a certeza que pretende eliminar esta mensagem<strong><span id='alteravel'></span></strong>?</p>
            <ul>
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-envelope'></i> Contactos</h1>

                <h3>Verifique as mensagens de contacto dos utilizadores.</h3></div>
               ...
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Contactos</strong> Suporte</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-3" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $query = "SELECT * FROM contactos ORDER BY idContacto ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        
                                        mysqli_stmt_bind_result($stmt, $idContacto, $nomeContacto, $emailContacto, $assuntoContacto, $textoContacto, $dataContacto);
                                        mysqli_stmt_execute($stmt);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            $conversaoDataTransmissao = new DateTime($dataContacto);
