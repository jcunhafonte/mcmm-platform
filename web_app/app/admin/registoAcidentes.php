...
Menus('acidentes', 'registoAcidentes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                ...
                <h3>Verifique os acidentes já registados aos seus colaboradores</h3></div>
...
if (isset($_GET['acidenteRemovido'])) {

    $acidenteRemovido = $_GET['acidenteRemovido'];

    $query = "SELECT id_colaborador, nome_completo FROM colaborador
                        WHERE id_colaborador = ?";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt, 'i', $acidenteRemovido);
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               O acidente do colaborador <b>$nomeCompletoRemovido</b> foi removido com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

if (isset($_GET['acidenteRemovidoErro'])) {

    $acidenteRemovidoErro = $_GET['acidenteRemovidoErro'];

    $query = "SELECT id_colaborador, nome_completo FROM colaborador
                        WHERE id_colaborador = ?";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt, 'i', $acidenteRemovidoErro);
    mysqli_stmt_bind_result($stmt, $idColaboradorRemovido, $nomeCompletoRemovido);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_fetch($stmt);
    mysqli_stmt_close($stmt);
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao remover o acidente do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoAcidentes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Acidentes</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <span id='titulo$idAcidente'>$nomeComportamento</span></a></td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='registoAcidentesDetalhes.php?colaborador=$refIdColaborador&acidente=$idAcidente' data-toggle='tooltip' title='Ver Detalhes'
                                                       class='text-center btn btn-default'><i class='fa fa-eye'></i></a>

                                                        <a href='editarAcidente.php?acidente=$idAcidente' data-toggle='tooltip' title='Editar Acidente'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>

                                                <a data-href='php/verificacoes/verificaCancelarAcidente.php?colaborador=$refIdColaborador&acidente=$idAcidente'
                                                    data-toggle='tooltip' title='Remover Acidente'
                                                    class='md-trigger text-center btn btn-default'
                                                      onclick='modalRemover($idAcidente);' id='botaoRemover$idAcidente'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Acidentes - <strong>$nomeCompletoApresenta</strong></h2>
