...
Menus('comportamento', 'registarComportamento');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-exclamation-triangle'></i> Comportamentos Não Aceitáveis</h1>
            </div>
            <!-- Page Heading End-->";
...
if (isset($_GET['sucesso'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               O comportamento do colaborador <b>$nomeCompletoAdicionada</b> foi adicionado com sucesso.<br>
...
if (isset($_GET['erro'])) {
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao adicionar o comportamento do colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Adicionar</strong> Comportamento</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaAdicionarComportamento.php'>
                        <div class='form-group'>
...
echo "</select>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-7'>
                                ...
                                name='descricaoComportamento'></textarea>
                            </div>
                            ...
                            <div class='col-sm-2'>
                                  <select class='form-control' name='danosComportamento'>
                                        ...
                                        <option value='Património'><b>Património</b></option>
                                        <option value='Imagem'><b>Imagem</b></option>
                                        <option value='Relações do Trabalho'><b>Relações do Trabalho</b></option>
                                        <option value='Funcionamento Interno'><b>Funcionamento Interno</b></option>
                                </select>
                            </div>

                            <div class='col-sm-3'>
                            <label for='inputEmail' class='control-label'>Situação Recorrente e/ou Grave&nbsp;&nbsp;</label>
                                            <label>
                                                <input type='radio' id='optionsRadios1'
                                                       value='Sim' name='situacaoComportamento'> &nbsp;Sim &nbsp;&nbsp;&nbsp;
                                            </label>
                                            <label>
                            ...
                            <div class='col-sm-4'>
                                ...
                                class='form-control' name='causasComportamento'></textarea>
                            </div>
                            ...
                            <div class='col-sm-2'>
                                  ...
                                  name='pessoasDecisaoComportamento' id='pessoasDecisao'>
                                        <option selected disabled>Pessoas a Envolver</option>
                                        <option value='Administração'><b>Administração</b></option>
                                        <option value='Apoio Jurídico'><b>Apoio Jurídico</b></option>
                                        <option value='DRH'><b>DRH</b></option>
                                        <option value='Outro'><b>Outro</b></option>
                                </select>
                            </div>

                             <div class='col-sm-2' id='outroPessoasDecisao' style='display: none'>
                                    <input name='' type='text' class='form-control' placeholder='Pessoas a Envolver'
                                    id='idPessoasDecisao'>
                                </div>
                            ...
                            <div class='col-sm-2'>
                                  ...
                                  name='sancaoComportamento' id='sancao'>
                                        <option selected disabled>Sanção</option>
                                        <option value='Verbal'><b>Verbal</b></option>
                                        <option value='Escrita'><b>Escrita</b></option>
                                        <option value='Outro'><b>Outro</b></option>
                                </select>
                            </div>

                             <div class='col-sm-2' id='outroSancao' style='display: none'>
                                    <input name='' type='text' class='form-control'
                                    id='idSancao' placeholder='Sanção'>
                            </div>
                            ...
                            <div class='col-sm-3'>
                                ...
                                name='comentariosComportamento'></textarea>
                            </div>
                            ...
                            <label for='inputEmail' class='control-label'>Oportunidade de Melhoria&nbsp;&nbsp;</label>
                                            <label>
                                                <input type='radio' id='optionsRadios1'
                                                       value='Sim' name='oportunidadeComportamento'> &nbsp;Sim &nbsp;&nbsp;&nbsp;
                                            </label>
                                            <label>
                            ...
                            <div class='col-sm-3'>
                                ...
                                class='form-control' name='documentosComportamento'></textarea>
                            </div>
