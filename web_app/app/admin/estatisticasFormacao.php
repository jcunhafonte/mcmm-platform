...
Menus('estatisticas', 'estatisticasFormacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Formação</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Horas de formação por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Horas de formação por ano</h2>
             ...
             <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Horas de formação por <strong>entidade</strong></h2>
<h2 id='segundo' style='display: none !important;'>Horas de formação por entidade</h2>
                            <div class='additional-btn'>
                                <a href='#' class='hidden reload'><i class='icon-ccw-1'></i></a>
    ...
    Morris.Bar({
        ...
        data: [
            <?php
             ...
             $inicioDataDesvinculacao = (date('Y') - 10);

while($inicioDataDesvinculacao <= date('Y')){

$query = "SELECT ano, SUM( duracao ) FROM formacoes WHERE ano = ?";

$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_param($stmt, 'i', $inicioDataDesvinculacao);
mysqli_stmt_bind_result($stmt, $anoAju, $resultadoAjua);
mysqli_stmt_execute($stmt);
mysqli_stmt_fetch($stmt);

if(empty($resultadoAjua)) {
$resultadoAjua = 0;
}

echo "{ y: '$inicioDataDesvinculacao', a: $resultadoAjua },";

$inicioDataDesvinculacao = $inicioDataDesvinculacao + 1;
...
$query = "SELECT entidade, SUM( duracao )
FROM formacoes GROUP BY entidade";

$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_result($stmt, $entidade, $resultadoDura);
mysqli_stmt_execute($stmt);

while( mysqli_stmt_fetch($stmt)){
echo "{ y: '$entidade', a: $resultadoDura},";
}
mysqli_stmt_close($stmt);
