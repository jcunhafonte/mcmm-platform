...
Menus('colaboradores', 'consultarDesvinculacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-user-times'></i> Entrevistas de Desvinculação</h1>

                <h3>Verifique as entrevistas de desvinculação já adicionadas aos seus colaboradores</h3></div>
...
if (isset($_GET['entrevistaRemovida'])) {

    $colaboradorRemovido = $_GET['entrevistaRemovida'];
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A entrevista de desvinculação do colaborador <b>$nomeCompletoRemovido</b> foi removida com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

if (isset($_GET['entrevistaRemovidaErro'])) {

    $colaboradorRemovido = $_GET['entrevistaRemovidaErro'];
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao remover a entrevista de desvinculação do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoEntrevistasDesvinculacao.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Entrevistas</h2>
...
INNER JOIN colaborador ON desvinculacao.ref_id_colaborador = colaborador.id_colaborador ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td><a href='perfilColaborador.php?colaborador=$refIdColaborador'><span id='titulo$idDesvinculacao'>$nomeColaborador</span></a></td>
  ...
  <a href='registoDesvinculacaoDetalhes.php?colaborador=$refIdColaborador&desvinculacao=$idDesvinculacao'
                                                data-toggle='tooltip' title='Ver Detalhes'
                                                class='text-center btn btn-default'><i class='fa fa-eye'></i></a>

                                            <a href='editarDesvinculacao.php?desvinculacao=$idDesvinculacao' data-toggle='tooltip' title='Editar Desvinculação'
                                                       class='text-center btn btn-default'><i class='fa fa-edit'></i></a>

                                                <a data-href='php/verificacoes/verificaCancelarDesvinculacao.php?colaborador=$refIdColaborador&desvinculacao=$idDesvinculacao'
                                                    data-toggle='tooltip' title='Remover Desvinculação' class='md-trigger text-center btn btn-default'
                                                      onclick='modalRemover($idDesvinculacao);' id='botaoRemover$idDesvinculacao'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Entrevistas - <strong>$nomeCompletoApresenta</strong></h2>
