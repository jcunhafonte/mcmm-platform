...
$query = "SELECT COUNT(id_colaborador) FROM colaborador WHERE ativo = 1";
...
$query = "SELECT visitas FROM administrador";
$stmt = mysqli_prepare($link, $query);
mysqli_stmt_bind_result($stmt, $totaisVisitas);
mysqli_stmt_execute($stmt);
mysqli_stmt_fetch($stmt);
mysqli_stmt_close($stmt);
        ...
        <div class='col-lg-6 col-md-6'>
            <div class='widget green-1 animated fadeInDown'>
                <div class='widget-content padding'>
                    ...
                    <div class='text-box'>
                        <p class='maindata'><b>VISITAS</b> TOTAIS</p>

                        <h2><span class='animate-number' data-value='<?php echo $totaisVisitas; ?>'
        ...
        <div class='col-lg-6 col-md-6'>
            <div class='widget lightblue-1 animated fadeInDown'>
                <div class='widget-content padding'>
                    ...
                    <div class='text-box'>
                        <p class='maindata'><b>COLABORADORES</b> TOTAIS</p>
    ...
    <div class='row'>
        ...
        <div class='col-lg-4 col-md-6 portlets'>
            <div id='weather-widget' class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Meteorologia</strong></h2>
