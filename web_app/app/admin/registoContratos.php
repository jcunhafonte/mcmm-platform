...
Menus('colaborador', 'consultarContratos');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-user-plus'></i> Consultar Contratos</h1>

                <h3>Verifique os contratos já adicionados aos seus colaboradores</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoContratos.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Contratos</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        if($textoDataInicioContrato == "01-01-1970"){
            $textoDataInicioContrato = "Não foi inserida uma data";
        }

        $conversaoFinalContrato = new DateTime($dataFinalContrato);
        $textoFinalContrato = $conversaoFinalContrato->format('d-m-Y');

        if($textoFinalContrato == "01-01-1970"){
            $textoFinalContrato = "Não foi inserida uma data";
        }
...
<td>$textoAtualContrato</td>
 <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                              <a href='registoContratoDetalhes.php?colaborador=$refIdColaboradorContrato&contrato=$idContrato'
                                                data-toggle='tooltip' title='Ver Detalhes'
                                                class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
<a href='editarContrato.php?contrato=$idContrato' data-toggle='tooltip' title='Editar Contrato'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>";
        if ($atualContrato == 1) {
        } else {

            echo "<a data-href='php/verificacoes/verificaRemoverContrato.php?colaborador=$refIdColaboradorContrato&contrato=$idContrato'
                                                    data-toggle='tooltip' title='Remover Contrato' class='md-trigger text-center btn btn-default'
                                                      onclick='modalRemover($idContrato);' id='botaoRemover$idContrato'
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Contratos - <strong>$apresentaNomeFormacoes</strong></h2>
