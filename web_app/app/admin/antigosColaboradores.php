    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-user-times'></i> Antigos Colaboradores</h1>

                <h3>Verifique os antigos colaboradores, reative os seus contratos ou edite dados</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['contratoReativo'])) {

                        $colaboradorReativo = $_GET['contratoReativo'];

                        $query = "SELECT id_colaborador, nome_completo FROM colaborador
                        WHERE id_colaborador = ?";

                        $stmt = mysqli_prepare($link, $query);
                        mysqli_stmt_bind_param($stmt, 'i', $colaboradorReativo);
                        mysqli_stmt_bind_result($stmt, $idColaboradorReativo, $nomeCompletoReativo);
               ...
               O contrato do colaborador <b>$nomeCompletoReativo</b> foi reativado com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['contratoReativoErro'])) {

                        $colaboradorReativo = $_GET['contratoReativoErro'];
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao reativar o contrato do colaborador <b>$nomeCompletoReativo</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Antigos</strong> Colaboradores</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-3" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $ativo = 0;
                                        $query = "SELECT id_colaborador, nome_completo, nascimento,
                                      data_admissao, localidade, telemovel, funcao FROM colaborador
                                      WHERE ativo = ? ORDER BY nome_completo ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $ativo);
                                        mysqli_stmt_bind_result($stmt, $idColaborador, $nomeCompleto,
                                            $dataNascimento, $dataAdmissao, $localidade, $telemovel, $funcao);
                                        mysqli_stmt_execute($stmt);

                                        while (mysqli_stmt_fetch($stmt)) {

                                            //Remover Horas de Datas
                                            $conversaoDataAdmissao = new DateTime($dataAdmissao);
                                            ...
                                            echo "<tr>
                                            <td>
                                            <a href='perfilColaborador.php?colaborador=$idColaborador'><span id='titulo$idColaborador'>$nomeCompleto</span></a></td>
                                            <td>";
                                            echo $from->diff($to)->y;
                                            echo "</td>
                                            <td>$funcao</td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='perfilColaborador.php?colaborador=$idColaborador' data-toggle='tooltip' title='Ver Perfil'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-eye'></i></a>
                                                    <a href='editarPerfil.php?colaborador=$idColaborador' data-toggle='tooltip'
                                                    title='Editar Perfil'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>
                                                               <a data-href='php/verificacoes/verificaReativarContrato.php?colaborador=$idColaborador' data-toggle='tooltip' title='Reativar Contrato'
                                                       class='text-center btn btn-default md-trigger'
                                                         onclick='modalRemover($idColaborador);'
id='botaoRemover$idColaborador' data-target='#md-fade-in-scale-up'  data-modal='md-fade-in-scale-up'>
