...
Menus('estatisticas', 'estatisticasAcidentes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Acidentes de Trabalho</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de acidentes de trabalho por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Número de acidentes de trabalho por ano</h2>
             ...
             <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de acidentes de trabalho por <strong>função</strong></h2>
<h2 id='segundo' style='display: none !important;'>Número de acidentes de trabalho por função</h2>
                            <div class='additional-btn'>
                                <a href='#' class='hidden reload'><i class='icon-ccw-1'></i></a>
...
$query = "SELECT YEAR( data_acidente ), COUNT( id_acidente )
FROM acidentes WHERE YEAR( data_acidente ) = ?";
...
$query = "SELECT COUNT(acidentes.id_acidente), acidentes.ref_id_colaborador, acidentes.data_acidente,acidentes.departamento,
...
acidentes.resultados, acidentes.controlo, acidentes.data_conclusao, acidentes.observacoes, acidentes.eficacia,
 acidentes.responsavel, acidentes.data_fecho, colaborador.nome_completo, colaborador.ativo, colaborador.funcao
FROM acidentes INNER JOIN colaborador ON acidentes.ref_id_colaborador = colaborador.id_colaborador
GROUP BY colaborador.funcao";
    ...
    mysqli_stmt_bind_result($stmt, $idAcidente, $refIdColaborador, $dataAcidente,
        ...
        $dataFechoAcidente, $nomeComportamento, $ativoComportamento, $funcaoColaborador);

mysqli_stmt_execute($stmt);

while( mysqli_stmt_fetch($stmt)){
echo "{ y: '$funcaoColaborador', a: $idAcidente},";
}
mysqli_stmt_close($stmt);
