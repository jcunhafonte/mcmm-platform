...
Menus('estatisticas', 'estatisticasMedicina');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-line-chart'></i> Estatísticas - Medicina de Trabalho</h1>
            </div>
            <!-- Page Heading End-->
            <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de consultas por <strong>ano</strong></h2>
<h2 id='primeiro' style='display: none !important;'>Número de consultas por ano</h2>
             ...
             <div class='row'>
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header transparent'>
                            <h2>Número de consultas por <strong>tipo de consulta</strong></h2>
...
$query = "SELECT YEAR( data_consulta ), COUNT( id_medicina )
FROM medicina WHERE YEAR( data_consulta ) = ?";
...
$query = "SELECT tipo_consulta, COUNT( id_medicina )
FROM medicina GROUP BY tipo_consulta";
