...
$(document).ready(function () {
    ...
    //var cTime = new Date(), day = cTime.getDay() + 5, month = cTime.getMonth() + 1, year = cTime.getFullYear();
    //console.log(day);
    //var events = [
    //    {
    //        "date": day + "/" + month + "/" + year,
...
function load_charts() {
    ...
    //      {period: '2012 Q2', iphone: 1299999999999999432, ipad: 579999999999999999913, itouch: 37999999999999991}
    //    ],
        ...
        series: [
            {
                ...
                name: 'Base de Dados do Servidor'
            }
        ]
    });
    var hoverDetail = new Rickshaw.Graph.HoverDetail({
