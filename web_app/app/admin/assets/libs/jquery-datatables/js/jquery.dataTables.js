...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Não há dados para apresentar" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Não há dados para apresentar"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Não há dados para apresentar",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Não há resultados para apresentar",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Filtrando resultados de _MAX_ totais)",
