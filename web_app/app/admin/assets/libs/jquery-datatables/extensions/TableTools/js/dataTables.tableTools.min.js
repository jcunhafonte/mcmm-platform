...
(function (m, k, p) {
    var r = function (n) {
        ...
        TableTools.BUTTONS = {
            ...
            copy: e.extend({}, TableTools.buttonBase, {
                ...
                fnComplete: function (a, b, c, d) {
                    ...
                    this.fnInfo("<h6>Tabela copiada</h6><p>Copiadas " +
                    a + " linha" + (1 == a ? "" : "s") + ".</p>", 1500)
                }
            }),
            ...
            print: e.extend({},
                TableTools.buttonBase, {
                    //sInfo: "<h6 style='margin-bottom: 20px !important;" +
                    //"'>Impressão</h6><p>Utilize as ferramentas do seu browser para imprimir, por favor. Pressione Escape quando terminar.</p>",
                    //sMessage: null,
                    //bShowAll: !0,
        ...
        TableTools.classes = {
            ...
            //print: {body: "DTTT_PrintA", info: "DTTT_print_info", message: "DTTT_PrintMessage"}
        };
