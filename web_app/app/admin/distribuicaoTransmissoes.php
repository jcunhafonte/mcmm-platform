    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-map-marker'></i> Distribuição das Transmissões</h1>
            </div>
...
<script>
    var macDoList = [
        ...
        $query = "SELECT id_transmissao, nome, latitude, longitude, nome_utilizador, transmissoes.ativo FROM transmissoes INNER JOIN utilizadores ON id_utilizador = ref_id_utilizador";
        $stmt = mysqli_prepare($link, $query);
        mysqli_stmt_bind_result($stmt, $idTransmissao, $nomeTransmissao, $latitude, $longitude, $nomeUser, $ativo);
        ...
        while (mysqli_stmt_fetch($stmt)){
            if(!empty($latitude) AND (!empty($longitude))){
                    ...
                    echo "{address: '$morada', data: {type: $ativo, drive: false, zip: '$nomeUser', city: '<a href="; 
                    echo "../guardadosDetalhes.php?transmissao=$idTransmissao"; echo ">$nomeTransmissao</a>'}, options:{icon: new google.maps.MarkerImage('";
                    if($ativo==1){
                        echo "php/icons/photo.png";
                    }else{
                        echo "php/icons/photo_off.png";
                    }
                    echo "')}, },";
            }
        }
