...
Menus('medicina', 'registoMedicina');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                ...
                <h3>Verifique as consultas já realizadas pelos seus colaboradores</h3></div>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='registoMedicina.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0) ) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Consultas</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <span id='titulo$idMedicina'>$nomeCompletoColaborador</span></a></td>
                                            ...
                                            <td>$aptidaoMedicina</td>
                                               <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                            <a href='editarMedicina.php?medicina=$idMedicina' data-toggle='tooltip' title='Editar Consulta'
                                                    ...
                                                    data-toggle='tooltip' title='Remover Consulta'
                                                     onclick='modalRemover($idMedicina);'

id='botaoRemover$idMedicina'
 data-target='#md-fade-in-scale-up'
  data-modal='md-fade-in-scale-up'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Consultas - <strong>$nomeCompletoApresenta</strong></h2>
