...
Menus('comunicacoes', 'comunicacaoDesvinculacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
              <h1><i class='fa fa-comments'></i> Comunicações - Entrevistas de Desvinculação</h1>

                <h3>Selecione a entrevista de desvinculação que deseja ver impressa para apresentar ao seu colaborador</h3>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoDesvinculacao.phpim' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Entrevistas</h2>
...
INNER JOIN colaborador ON desvinculacao.ref_id_colaborador = colaborador.id_colaborador ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
      ...
      <a href='imprimirDesvinculacaoDetalhes.php?colaborador=$refIdColaborador&desvinculacao=$idDesvinculacao'
                                                    data-toggle='tooltip' title='Ver Comunicação' id='botaoRemover$idDesvinculacao'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Entrevistas - <strong>$nomeCompletoApresenta</strong></h2>
