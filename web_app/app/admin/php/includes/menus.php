...
function Menus($menuPai = '', $menuFilho = '', $menuNeto = '')
{
    ...
    echo "<li class='dropdown iconify hide-phone'><a href='#' onclick='javascript:toggle_fullscreen()'><i
                        ...
                        <li class='dropdown topbar-profile'>
                            <a href='#' class='dropdown-toggle' data-toggle='dropdown'><span
                                 ...
                                 <strong>$_SESSION[nomeAdmin]</strong> <i class='fa fa-caret-down'></i></a>
        ...
        <div class='sidebar-inner slimscrollleft'>
            ...
            <div class='profile-info'>
                ...
                <div class='col-xs-8' style='margin-top: 10px'>
                    <div class='profile-text'>Administrador <b>$_SESSION[nomeAdmin]</b></div>
                </div>
            </div>
            <div class='clearfix'></div>
            <!--- Divider -->
    ...
    echo " href='utilizadoresDesativos.php'><span>Utilizadores Inativos</span></a></li>
    ...
    echo " href='javascript:void(0);'><i
                                class='fa fa-video-camera'></i><span>Transmissões</span>
                                <span class='pull-right'><i
                                    class='fa fa-angle-down'></i></span></a>
                        <ul>
                            <li><a ";

    if ($menuFilho == 'transmissoesAtivas') {
        echo "class='active'";
    }

    echo " href='transmissoesAtivas.php'><span>Transmissões Ativas</span></a></li>

    <li><a ";

    if ($menuFilho == 'transmissoesDesativas') {
        echo "class='active'";
    }

    echo " href='transmissoesDesativas.php'><span>Transmissões Desativas</span></a></li>

                        </ul>
                    </li>
                    <li><a ";

    if ($menuPai == 'agendamentos') {
        echo "class='active'";
    }

    echo " href='agendamentos.php'>
                    <i class='fa fa-calendar'></i><span>Agendamentos</span></a>
                    </li>
                    <li><a ";

    if ($menuPai == 'exportdata') {
        echo "class='active'";
    }
    ...
    if ($menuPai == 'comentarios') {
        echo "class='active'";
    }

    echo " href='javascript:void(0);'><i
                                class='fa fa-file-text'></i><span>Comentários</span>
                                <span class='pull-right'><i
                                    class='fa fa-angle-down'></i></span></a>
                        <ul>
                            <li><a ";

    if ($menuFilho == 'eliminarComentarios') {
        echo "class='active'";
    }

    echo " href='comentarios.php'><span>Eliminar Comentários</span></a></li>

    <li><a ";

    if ($menuFilho == 'gerirDenuncias') {
        echo "class='active'";
    }

    echo " href='gerirDenuncias.php'><span>Gerir Denúncias</span></a></li>
    ...
    echo " href='distribuicaoTransmissoes.php'>
                    <i class='fa fa-map-marker'></i><span>Mapa de Transmissões</span></a>
                    </li>
                    <li><a ";
