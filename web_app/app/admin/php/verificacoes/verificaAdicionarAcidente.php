...
/////
   ...
   $query = "INSERT INTO acidentes(ref_id_colaborador, data_acidente, departamento, numero_processo, atividade, descricao,
lesoes, causas, categoria, tipologia, tratamento, ausencia_horas, ausencia_dias, acao, numero_acao, tipo_acao,
descricao_acao, data_implementacao, resultados, controlo, data_conclusao, observacoes, eficacia, responsavel, data_fecho)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt, 'issssssssssssssssssssssss',$colaboradorAcidente, $novaDataAcidente,
        ...
        $novaDataFechoAcidente);

    if(mysqli_stmt_execute($stmt)){
        mysqli_stmt_close($stmt);
        header('location:../../adicionarAcidentesTrabalho.php?sucesso='.$colaboradorAcidente);
    }else{
        mysqli_stmt_close($stmt);
        header('location:../../adicionarAcidentesTrabalho.php?erro='.$colaboradorAcidente);
    }
