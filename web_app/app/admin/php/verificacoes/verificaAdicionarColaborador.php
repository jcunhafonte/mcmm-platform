...
// Terceira Parte
    ...
    if (isset($_POST['dataFinalContratoColaborador'])) {
        ...
        if($novaDataFinalContratoColaborador < date('Y-m-d H:i:s')){
            $ativo = 0;
        }else{
            $ativo = 1;
        }
...
processo_admissao, data_final_contrato, ativo)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($link, $query);

    mysqli_stmt_bind_param($stmt, 'sssssiissssisssiisssssssisiissiiissssisiississsssiisi',
        ...
        $percentagemEntPatronalColaborador, $funcaoColaborador, $categoriaColaborador,
        $situacaoContratualColaborador, $postoTrabalhoColaborador, $periodoExperimentalColaborador,
        $novaDataFinalPeriodoExperimentalColaborador,
        ...
        $procRecrutamento, $procAdmissao, $novaDataFinalContratoColaborador, $ativo);
