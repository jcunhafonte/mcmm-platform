...
mysqli_stmt_bind_result($stmt, $apresentaNomeFormacoes,
    $idColaboradorFormacoes, $ativoFormacoes, $moradaColaborador, $funcaoColaborador, $categoriaColaborador, $telmColaborador,
    $telfColaborador, $codPostalColaborador,  $localidadeColaborador);
...
<tr><td>&nbsp;</td></tr>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Dias Presentes</h3><br>";
...
while (mysqli_stmt_fetch($stmt)) {
    ...
    echo "<h4 style='display: inline; font-weight: normal !important;'>$textoConversaoDataPresencas</h4><br>";
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Total de Presenças</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>$dias dias</h4>
								...
								<td colspan='2' style='padding-top: 10px!important; padding-bottom:  15px !important;'>
	                                ...
	                                <h3 style='display: inline;  padding-bottom: 10px !important;'>Subsídio de Alimentação</h3><br>
                                    <h4 style='display: inline; font-weight: normal !important;'>";
$subsidioAlimentacao = $dias * 8;
echo $subsidioAlimentacao; echo ",00€";
echo "</h4>
						...
						<tbody>
							...
							<tr>
								<td style='width:50%!important; text-align: center !important; padding-top: 10px!important; padding-bottom:  15px !important;'>
                                    ...
                                    <h4 style='display: inline; font-weight: normal !important; text-align: center'>($apresentaNomeFormacoes)</h4>
