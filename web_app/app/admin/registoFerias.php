    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                ...
                <h3>Verifique as férias já destacadas aos seus colaboradores</h3></div>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>Todos os Colaboradores</strong></h2>
...
ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            ...
                                            <span id='titulo$idFerias'>$nomeCompletoColaborador</span></a></td>
        ...
        echo "</td>
                                               <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                            <a href='editarFerias.php?ferias=$idFerias' data-toggle='tooltip' title='Editar Férias'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>
                                                    <a data-href='php/verificacoes/verificaCancelarFerias.php?colaborador=$idColaborador&ferias=$idFerias'
                                                    data-toggle='tooltip' title='Cancelar Férias'
                                                     onclick='modalRemover($idFerias);' id='botaoRemover$idFerias'
                                                        data-target='#md-fade-in-scale-up'  data-modal='md-fade-in-scale-up'
                                                       class='text-center btn btn-default md-trigger'><i
...
if ((!isset($_GET['mesFerias'])) AND (!isset($_GET['anoFerias']))
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Férias</h2>
...
if ((isset($_GET['mesFerias'])) AND (isset($_GET['anoFerias'])) AND (!isset($_GET['colaboradorFerias']))) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis</h2>
...
colaborador.ativo FROM colaborador WHERE colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Registo de Férias - <strong>$mes_extenso[$mes] de $ano</strong> - $nr_work_days Dias Úteis - <strong>$apresentaNomeFormacoes</strong></h2>
