...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Contratos</title>
...
Menus('exportarDados', 'qualidadeContratos');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                 <h1><i class='fa fa-table'></i> Exportar Dados - Contratos</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosContratos.php' method='get'>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
    ...
    $textoPerExperimental = $conversaoPerExperimental->format('d-m-Y');
        ...
        echo "<tr>
                                            <td>$nomeColaboradorContrato</td>
                                            <td>";
        echo $textoDataAtual;
        echo "</td>
                                            <td>$funcaoContrato</td>
                                            <td>$categoriaContrato</td>
                                            <td>";
        echo $postoTrabalhoContrato;
        echo "</td>
                                            <td>$situacaoContratualContrato</td>
                                            <td>$textoDataInicioContrato</td>
                                            <td>$textoPerExperimental</td>
                                            <td>"; if(!empty($NIBContrato)){echo "$NIBContrato";}echo "</td>
                                            <td>";
        echo $textoAtualContrato;
        echo "</td>
                                            <td>$vencimentoBaseContrato";echo "€</td>
                                            <td>$textoFinalContrato</td>
                                        </tr>";
    }
    mysqli_stmt_close($stmt);
    ...
    $query = "SELECT contrato.id_contrato, colaborador.nome_completo, colaborador.ativo
FROM contrato INNER JOIN colaborador ON contrato.ref_id_colaborador = colaborador.id_colaborador
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";

    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_result($stmt, $idContrato2, $nomeComportamento, $ativoComportamento);
    mysqli_stmt_execute($stmt);
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        $query2 = "SELECT contrato.id_contrato, contrato.situacao_contratual, contrato.funcao, contrato.posto_trabalho,
contrato.periodo_experimental, contrato.data_final_per_experimental, contrato.horas_semanais, contrato.horas_diarias,
contrato.descanso_complementar, contrato.sistema_rotativo, contrato.NIB, contrato.instituicao_bancaria,
contrato.agencia, contrato.vencimento_base, contrato.categoria, contrato.data_admissao, contrato.ref_id_colaborador,
contrato.data_contrato, contrato.data_final_contrato, contrato.atual,
...
WHERE colaborador.ativo = 1 AND contrato.id_contrato = ? ORDER BY colaborador.nome_completo ASC";
        ...
        mysqli_stmt_bind_param($stmt2, 's', $idContrato2);
        mysqli_stmt_bind_result($stmt2, $idContrato, $situacaoContratualContrato, $funcaoContrato, $postoTrabalhoContrato,
            $perExperimentalContrato, $novaDataFinalPerExperimental, $horasSemanaisContrato, $horasDiariasContrato,
            $descansoContrato, $sistemaRotativoContrato, $NIBContrato, $instBancariaContrato, $agenciaContrato,
            $vencimentoBaseContrato, $categoriaContrato, $dataInicioContrato, $refIdColaboradorContrato, $dataAtual,
            $dataFinalContrato, $atualContrato, $nomeColaboradorContrato,
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$nomeColaboradorContrato</td>
                                            <td style='border-bottom: none !important; width:90px; text-align: center !important;'>$textoDataInicioContrato</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$funcaoContrato</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$categoriaContrato</td>
                                        </tr>";
        ...
        echo "<tr>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$postoTrabalhoContrato</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$situacaoContratualContrato</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$textoDataInicioContrato</td>
                                            <td style='border-bottom: none !important; text-align: center !important;'>$textoPerExperimental</td>
                                        </tr>";
        ...
        echo "<tr>
                                            <td style='text-align: center !important;'>"; if(!empty($NIBContrato)){echo "$NIBContrato";} echo "</td>
                                            <td style='text-align: center !important;'>$textoAtualContrato</td>
                                            <td style='text-align: center !important;'>$vencimentoBaseContrato";echo "€</td>
<td style='text-align: center !important;'>$textoFinalContrato";echo "</td>
                                        </tr>";
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Contratos</strong> - <strong>$apresentaNomeFormacoes</strong></h2>
