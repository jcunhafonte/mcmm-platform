...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Eliminar agendamento</h3>

        <div>
            <p>Tem a certeza que pretende eliminar este agendamento<strong><span id='alteravel'></span></strong>?</p>
            <ul>
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-calendar'></i> Agendamentos</h1>

                <h3>Listagem de agendamentos de transmissões.</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['agendamentoRemovido'])) {

                        echo "<div class='alert alert-success alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               O agendamento foi removido com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['agendamentoRemovidoErro'])) {

                        
                        echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao eliminar o agendamento.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Agendamentos</strong> Transmissões</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-3" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $query = "SELECT agendamentos.id_agendamentos, agendamentos.titulo, agendamentos.categoria, agendamentos.data_da_transmissao, agendamentos.descricao, utilizadores.nome_utilizador, utilizadores.id_utilizador
                                      FROM agendamentos INNER JOIN utilizadores ON utilizadores.id_utilizador = agendamentos.ref_id_utilizador";
                                        $stmt = mysqli_prepare($link, $query);
                                        
                                        mysqli_stmt_bind_result($stmt, $idAgenda, $tituloAgenda, $categoriaAgenda, $dataAgenda, $descricaoAgenda, $nomeUser, $idUser);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            $conversaoDataTransmissao = new DateTime($dataAgenda);
                                            ...
                                            <td>$tituloAgenda</td>
                                            <td>$categoriaAgenda</td>
                                            <td>$textoDataTransmissao</td>
                                            <td>$descricaoAgenda</td>
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    <a data-href='php/verificacoes/verificaDesativarAgendamento.php?agendamento=$idAgenda' data-toggle='tooltip' title='Eliminar Agendamento' class='text-center btn btn-default md-trigger' id='botaoRemover$idAgenda' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' onclick='modalRemover($idAgenda);'><i class='fa fa-user-times'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
