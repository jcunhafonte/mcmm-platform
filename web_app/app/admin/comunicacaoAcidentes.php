...
Menus('comunicacoes', 'comunicacaoAcidentes');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                <h1><i class='fa fa-comments'></i> Comunicações - Acidentes de Trabalho</h1>

                <h3>Selecione o registo de acidentes de trabalho que deseja ver impresso para apresentar ao seu colaborador</h3>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='comunicacaoAcidentes.php' method='get'>
...
if ((!isset($_GET['colaborador'])) || ($_GET['colaborador'] == 0)) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Comunicação</strong> de Acidentes de Trabalho</h2>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC ";
        ...
        echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                  ...
                                                  <a href='imprimirAcidentesDetalhes.php?colaborador=$idColaborador&acidente=$idAcidente'
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Registo</strong> de Acidentes de Trabalho - <strong>$nomeCompletoApresenta</strong></h2>
