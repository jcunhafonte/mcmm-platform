...
<div id='wrapper'>
    ...
    Menus('medicina', 'calendarioMarcacoes'); ?>
                ...
                <div class='col-md-12'>
                    <div class='widget'>
                        <div class='widget-header'>
                            <h2>Calendário de Marcações de Consultas</h2>
...
<script>
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events: [
                    ...
                    <?php
                     ...
                     $query = "SELECT COUNT( id_marcacao ) FROM marcacao_consulta INNER JOIN colaborador
    ON marcacao_consulta.ref_id_colaborador = colaborador.id_colaborador WHERE (data_consulta > CURDATE( ))
    ...
    if (mysqli_stmt_num_rows($stmt) > 0) {
        ...
        $query = "SELECT data_consulta, ref_id_colaborador, nome_completo
    FROM marcacao_consulta INNER JOIN colaborador ON colaborador.id_colaborador = marcacao_consulta.ref_id_colaborador
    WHERE data_consulta > CURDATE( ) AND colaborador.ativo = 1 ORDER BY data_consulta ASC";

        $stmt = mysqli_prepare($link, $query);
        mysqli_stmt_bind_result($stmt, $dataConsulta, $idColaborador, $nomeCompleto);
        mysqli_stmt_execute($stmt);
        ...
        setTimeout(function () {
            ...
            html2canvas($("#calendar"), {
                ...
                onrendered: function (canvas) {
                    ...
                    var nomeImagem = "Calendário de Marcações de Consultas - " + $('.fc-header-title h2').html();
