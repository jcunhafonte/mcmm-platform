...
Menus('mudancas', 'registarMudancas');
...
if (isset($_GET['sucesso'])) {
    ...
    echo "<div class='alert alert-success alert-dismissable'>
               ...
               A mudança de função do colaborador <b>$nomeCompletoAdicionada</b> foi adicionada com sucesso.<br>
...
if (isset($_GET['erro'])) {
    ...
    echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao adicionar a mudança de função do colaborador <b>$nomeCompletoAdicionada</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
}

echo "<div class='widget'>
                <div class='widget-header transparent'>
                    <h2><strong>Adicionar</strong> Mudança</h2>
                ...
                <div class='widget-content padding'>
                    ...
                    action='php/verificacoes/verificaAdicionarMudancas.php'>
                        <div class='form-group'>
...
echo "</select>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-2'>
                                 <select id='pessoasDecisao' class='form-control' name='funcaoMudanca'
                                 onchange='apresentacaInputTexto();'>
                                    ...
                                    <div id='outroPessoasDecisao' style='display: none'>
                                              <label for='input-text' class='col-sm-1'>Qual?</label>
                                                <div class='col-sm-2'>
                                             <input name='' type='text' class='form-control' id='idPessoasDecisao'>
                                             </div>
                                    </div>
                            ...
                            <label for='inputEmail' class='control-label'>Medida Eficaz?&nbsp;&nbsp;</label>
                                            <label>
                                                <input type='radio' id='optionsRadios1'
                                                       value='Sim' name='eficaciaMudanca'> &nbsp;Sim &nbsp;&nbsp;&nbsp;
                                            </label>
                                            <label>
                            ...
                            <div class='col-sm-4'>
                                ...
                                name='comentarioMudanca'></textarea>
                            </div>
