...
<head>
    <meta charset='UTF-8'>
    <title>BN, Lda - Relatório Formação</title>
...
Menus('exportarDados', 'qualidadeFormacao');
    ...
    <div class='content-page'>
        ...
        <div class='content'>
            ...
            <div class='page-heading'>
                 <h1><i class='fa fa-table'></i> Exportar Dados - Formação</h1>
            ...
            <div class='widget-header'>
                <h2><strong>Filtrar</strong> por Colaborador</h2>
                    ...
                    <div class='form-group'>
                        ...
                        <form action='exportarDadosFormacao.php' method='get'>
...
WHERE colaborador.ativo = 1 ORDER BY colaborador.nome_completo ASC";
    ...
    while (mysqli_stmt_fetch($stmt)) {
        ...
        echo "<tr>
                                            <td style='text-align: center !important;'>$nomeFormacoes</td>
                                            <td style='text-align: center !important;'>";
        echo $anoFormacoes;
        echo "</td>
                                            <td style='text-align: center !important;'>$descricaoFormacoes</td>
                                            <td style='text-align: center !important;'>$textoDuracaoFormacoes</td>
                                            <td style='text-align: center !important;'>";
        echo $entidadeFormacoes;
        echo "</td>
                                        </tr>";
...
AND colaborador.id_colaborador = ?";
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2><strong>Formação</strong> - <strong>$apresentaNomeFormacoes</strong></h2>
                                ...
                                <thead>
                                 ...
                                 <tr width='100%'>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td>
                                            <h3><strong>Formação</strong> - <strong>$apresentaNomeFormacoes</strong></h3>
                                            </td>
                                            </tr>
                                </table>

                                    <table border='1' id='' class='table table-striped table-bordered' cellspacing='0'
                                           width='100%'>
                                        <thead>
                                        <tr>
                                            <th>Nome</th>
