...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        ...
        <div>
            <p>Tem a certeza que pretende cancelar o contrato do colaborador <strong><span id='alteravel'></span></strong>?</p>
            <ul>
...
<div id="wrapper">
    ...
    Menus('colaboradores', 'atualColaborador');
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-users'></i> Atuais Colaboradores</h1>

                <h3>Verifique os atuais colaboradores, cancele contratos ou edite dados</h3></div>
            ...
            <div class="row">
               ...
               O contrato do colaborador <b>$nomeCompletoRemovido</b> foi cancelado com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
               Ocorreu um erro ao cancelar o contrato do colaborador <b>$nomeCompletoRemovido</b>.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Atuais</strong> Colaboradores</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-3" class="table table-striped table-bordered" cellspacing="0"
                                      ...
                                      data_admissao, medicina_trabalho, vencimento_base, funcao FROM colaborador
                                      WHERE ativo = ? ORDER BY nome_completo ASC";
                                        ...
                                        mysqli_stmt_bind_result($stmt, $idColaborador, $nomeCompleto,
                                            $dataNascimento, $dataAdmissao, $medicinaTrabalho, $vencimentoBase, $funcao);
                                        mysqli_stmt_execute($stmt);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            echo "<tr>
                                            <td>
                                            <a href='perfilColaborador.php?colaborador=$idColaborador'>
                                            <span id='titulo$idColaborador'>$nomeCompleto</span></a>
                                            </td>
                                            <td>";
                                            echo $from->diff($to)->y;
                                            echo "</td>
                                            <td>$textoDataAdmissao</td>
                                            <td>$funcao</td>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='perfilColaborador.php?colaborador=$idColaborador' data-toggle='tooltip' title='Ver Perfil'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-eye'></i></a>
                                                             <a href='editarPerfil.php?colaborador=$idColaborador' data-toggle='tooltip' title='Editar Perfil'
                                                       class='text-center btn btn-default'><i
                                                            class='fa fa-edit'></i></a>
                                                    <a data-href='adicionarDesvinculacao.php?colaborador=$idColaborador'
                                                    data-toggle='tooltip' title='Cancelar Contrato' class='text-center btn btn-default md-trigger'
                                                    id='botaoRemover$idColaborador'
 data-target='#md-fade-in-scale-up'
  data-modal='md-fade-in-scale-up'   onclick='modalRemover($idColaborador);'
                                                    >
