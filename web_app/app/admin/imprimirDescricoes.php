...
Menus('descricao','imprimirDescricoes');
...
if (mysqli_stmt_num_rows($stmt) > 0) {
    ...
    echo "<div class='widget'>
                        <div class='widget-header'>
                            <h2>Imprimir <strong>Descrições</strong></h2>
    ...
    echo "<div class='widget'>
        ...
        echo "<tr>
                                    ...
                                    Dirija-se à area de Adicionar Descrições para ter a possibilidade de imprimir esta área.</td>
