...
<div id="platform">
    ...
    <div class="projects-header">
        <div class="contents" style="background-image: url(/images/backgrounds/publicar_noticia_slider.jpg)">
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="input-file-container">
                                                ...
                                                <label tabindex="0" for="my_image_1" id="label_my_image_1"
                                                       class="input-file-trigger">Imagem Necessária<br>(JPEG, JPG ou
                                                    PNG)</label>
                                            </div>
...
<script src="/scripts/publish-news-sliders-84eed08362.js"></script>
