...
function comments() {
    ...
    $('#remove_comment').on('submit', function (e) {
        ...
        $.ajax({
            url: '/api/verificacoes/video/removerComentario.php',
            type: 'POST',
            data: 'comentario=' + commentRemoved + "&video=" + $('#id_video_comment').val(),
    ...
    $('#alert_comment').on('submit', function (e) {
        ...
        $.ajax({
            url: '/api/verificacoes/video/denunciarComentario.php',
            type: 'POST',
            data: 'comentario=' + commentAlert + "&video=" + $('#id_video').val(),
            success: function (data) {
                noty({
...
function submitComment() {
    $.ajax({
        url: '/api/verificacoes/video/adicionarComentario.php',
        type: 'POST',
        data: 'video=' + $('#id_video_comment').val() + '&comentario=' + $('#comment').val(),
        success: function (data) {
...
function likes() {
    $('.heart-click').click(function (e) {
        ...
        if ($('button .heart').hasClass("fa-heart-o")) {
            ...
            $.ajax({
                url: '/api/verificacoes/video/adicionarGosto.php',
                type: 'POST',
                data: 'like=' + $('#id_video').val(),
            ...
            $.ajax({
                url: '/api/verificacoes/video/removerGosto.php',
                type: 'POST',
                data: 'like=' + $('#id_video').val(),
...
function listLikes() {
    $.ajax({
        url: '/api/verificacoes/video/listagemGostos.php',
        type: 'POST',
        data: 'video=' + $('#id_video').val(),
        success: function (data) {
