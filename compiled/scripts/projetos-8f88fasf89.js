...
function comments() {
    ...
    $('#remove_comment').on('submit', function (e) {
        ...
        $.ajax({
            url: '/api/verificacoes/projeto/removerComentario.php',
            type: 'POST',
            data: 'comentario=' + commentRemoved + "&projeto=" + $('#id_projeto_comment').val(),
    ...
    $('#alert_comment').on('submit', function (e) {
        ...
        $.ajax({
            url: '/api/verificacoes/projeto/denunciarComentario.php',
            type: 'POST',
            data: 'comentario=' + commentAlert + "&projeto=" + $('#id_projeto').val(),
            success: function (data) {
                noty({
...
function submitComment() {
    $.ajax({
        url: '/api/verificacoes/projeto/adicionarComentario.php',
        type: 'POST',
        data: 'projeto=' + $('#id_projeto_comment').val() + '&comentario=' + $('#comment').val(),
        success: function (data) {
