    ...
    $('#edit-video')
        .steps({
            ...
            onStepChanging: function (e, currentIndex, newIndex) {
                var fv = $('#edit-video').data('formValidation'), // FormValidation instance
                    $container = $('#edit-video').find('section[data-step="' + currentIndex + '"]');
                ...
                setTimeout(function () {
                    $('#edit-video')
                        ...
                        .formValidation('validateField', 'tipologia')
            ...
            onFinishing: function (e, currentIndex) {
                var fv = $('#edit-video').data('formValidation'),
                    $container = $('#edit-video').find('section[data-step="' + currentIndex + '"]');
...
$('#edit-video').submit(function (e) {
    ...
    var formData = new FormData($("#edit-video")[0]);
    $.ajax({
        type: 'POST',
        url: '/api/edit/videos_normal.php',
        data: formData,
        xhr: function () {
        ...
        success: function (data) {
            ...
            noty({
                text: 'O vídeo foi editado com <b>sucesso</b>!',
                type: 'success',
                layout: 'topRight',
