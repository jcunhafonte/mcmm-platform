...
<div id="platform">
    ...
    <div class="projects-header">
        <div class="contents" style="background-image: url(/images/backgrounds/publicar_projeto_slider.jpg)">
            <div class="container">
                <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 steps-wrapper">
                    ...
                    <form id="publish-projects-slider" class="form-horizontal"
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="input-file-container">
                                                <input class="input-file form-control" id="my_image_1" type="file"
                                                       name="image_1">
                                                <label tabindex="0" for="my_image_1" id="label_my_image_1"
                                                       class="input-file-trigger">Imagem Necessária<br>(JPEG, JPG ou PNG)</label>
                                            </div>
                                            <div class="multiple-image text-center">
                                                <img id="upload_img_1" src="/images/backgrounds/default_background.png">
                                            </div>
                                ...
                                <div class="col-xs-12 col-md-3">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="input-file-container">
                                                <input class="input-file form-control" id="my_image_2" type="file"
                                                       name="image_2">
                                                <label tabindex="0" for="my_image_2" id="label_my_image_2"
                                                       class="input-file-trigger">Imagem Necessária<br>(JPEG, JPG ou PNG)</label>
                                            </div>
                                            <div class="multiple-image text-center">
                                                <img id="upload_img_2" src="/images/backgrounds/default_background.png">
                                            </div>
                                ...
                                <div class="col-xs-12 col-md-3">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="input-file-container">
                                                <input class="input-file form-control" id="my_image_3" type="file"
                                                       name="image_3">
                                                <label tabindex="0" for="my_image_3" id="label_my_image_3"
                                                       class="input-file-trigger input-file-trigger-optional">Imagem
                                                    Opcional<br>(JPEG, JPG ou PNG)</label>
                                            </div>
                                            <div class="multiple-image text-center">
                                                <img id="upload_img_3" src="/images/backgrounds/default_background.png">
                                            </div>
                                ...
                                <div class="col-xs-12 col-md-3">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="input-file-container">
                                                <input class="input-file form-control" id="my_image_4" type="file"
                                                       name="image_4">
                                                <label tabindex="0" for="my_image_4" id="label_my_image_4"
                                                       class="input-file-trigger input-file-trigger-optional">Imagem
                                                    Opcional<br>(JPEG, JPG ou PNG)</label>
                                            </div>
                                            <div class="multiple-image text-center">
                                                <img id="upload_img_4" src="/images/backgrounds/default_background.png">
                                            </div>
...
<script src="/scripts/publish-projects-slider-d33e001f50.js"></script>
