...
<head>
    ...
    <script type="text/javascript" src="http://content.jwplatform.com/libraries/G1vj4svv.js"></script>
...
<div id="platform">
    ...
    <div class="projects-header">
        <div class="contents" style="background-image: url(/images/backgrounds/publicar_noticia_video.jpg)">
            <div class="container">
                <div class="row">
...
<script src="/scripts/publish-news-videos-c9f2ad3773.js"></script>
