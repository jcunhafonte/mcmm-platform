...
if ((isset($_SESSION['ativoAdmin'])) AND (isset($_POST['autor']))) {

    $query = "INSERT INTO testemunhos (autor, texto, profissao) VALUES (?, ?, ?)";
    $stmt = mysqli_prepare($link, $query);
    mysqli_stmt_bind_param($stmt, 'sss', $_POST['autor'], $_POST['testemunho'], $_POST['profissao']);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        if (isset($_FILES['fotografia'])) {
            ...
            if ((($_FILES["fotografia"]["type"] == "image/jpeg") || ($_FILES["fotografia"]["type"] == "image/png"))
                ...
                if ($_FILES["fotografia"]["error"] > 0) {
                    ...
                    $target_dir = "../../../api/utilizadores/testemunhos/";
        ...
        header("location:../../testemunhos.php?testemunhoAdicionado");

    } else {

        mysqli_stmt_close($stmt);
        header("location:../../testemunhos.php?testemunhoAdicionadoErro");
