...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        ...
        <div>
            <p>Tem a certeza que pretende ativar o vídeo <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da ativação pode voltar a desativar o vídeo.
                </li>
            ...
            <p>
                ...
                <a class='btn-remover' href=''><button class='btn btn-success md-close'>Ativar</button></a>
            </p>
        </div>
    </div>
    <!-- End div .md-content -->
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-sitemap'></i> Projetos Inativos</h1>

                <h3>Verifique os vídeos inativos e ative os que pretender</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['videoAdicionado'])) {

                        $transmissaoRemovida = $_GET['videoAdicionado'];

                        $query = "SELECT id_videos, titulo FROM videos WHERE id_videos = ?";
               ...
               O vídeo <b>$nomeTransmissaoRemovida</b> foi ativado com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['videoAdicionadoErro'])) {

                        $transmissaoRemovida = $_GET['videoAdicionadoErro'];
                        ...
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao ativar o vídeo <b>$nomeTransmissaoRemovida</b>.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Projetos</strong> Inativos</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-2" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $ativo = 0;
                                        $query = "SELECT videos.id_videos, videos.titulo, videos.data_publicacao,
                                        utilizadores.nome_utilizador, utilizadores.id_user, videos.ref_id_utilizador
                                        FROM videos
                                        INNER JOIN utilizadores ON utilizadores.id_utilizador = videos.ref_id_utilizador
                                        WHERE videos.ativo = ?
                                        ORDER BY videos.data_publicacao ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $ativo);
                                        mysqli_stmt_bind_result($stmt, $idVideos, $titulo, $dataPublicacao,
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            echo "<tr>
                                            <td>
                                                <a href='/video/$idVideos'>
                                                <span id='titulo$idVideos'>" .  htmlentities($titulo) . "</span>
                                                </a>
                                            </td>
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                	<a href='/video/$idVideos' data-toggle='tooltip' title='Ver Projeto' 
                                                	class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                    <a data-href='php/verificacoes/video/ativar.php?publicacao=$idVideos' 
                                                    data-toggle='tooltip' title='Ativar Vídeo' class='text-center btn btn-default md-trigger' 
                                                    id='botaoRemover$idVideos' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' 
                                                    onclick='modalRemover($idVideos);'><i class='fa fa-check'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
