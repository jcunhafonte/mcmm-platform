...
<div id="wrapper">
    ...
    Menus('noticias', 'comentariosDanunciadosNoticias');
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-file-text'></i> Comentários Denunciados</h1>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $query = "SELECT id_denuncia_comentarios_noticias, ref_id_utilizador_denunciador,
                                        ref_id_comentario, data_denuncia, ref_id_noticias
                                        FROM denuncia_comentarios_noticias
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            $query2 = "SELECT comentario FROM comentarios_noticias WHERE ref_id_noticia = ?";
                                            $stmt2 = mysqli_prepare($link2, $query2);
                                            mysqli_stmt_bind_param($stmt2, 's', $refIdNoticias);
                                            mysqli_stmt_execute($stmt2);
                                            mysqli_stmt_bind_result($stmt2, $comentario);
                                            mysqli_stmt_fetch($stmt2);
                                            mysqli_stmt_close($stmt2);

                                            $query2 = "SELECT titulo FROM noticias WHERE id_noticias = ?";
                                            $stmt2 = mysqli_prepare($link2, $query2);
                                            mysqli_stmt_bind_param($stmt2, 's', $refIdNoticias);
                                            mysqli_stmt_execute($stmt2);
                                            mysqli_stmt_bind_result($stmt2, $tituloNoticia);
                                            mysqli_stmt_fetch($stmt2);
                                            mysqli_stmt_close($stmt2);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='/new/$refIdNoticias'>". htmlentities($tituloNoticia) . "</a>
                                                </td>
                                                <td class='text-center'>
                                                    <div class='btn-group btn-group-xs text-center'>
                                                        <a href='/new/$refIdNoticias' data-toggle='tooltip' title='Ver Comentário' 
                                                        class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                        <a data-href='php/verificacoes/noticia/removerDenunciaComentario.php?comentario=$idDenunciaComentarios' 
