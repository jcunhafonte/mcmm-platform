    ...
    <div class='md-content'>
        ...
        <div>
            ...
            <ul>
                ...
                <li><strong>Informação:</strong> Após a confirmação da desativação pode voltar a reativar o utilizador.
                </li>
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                ...
                <h3>Verifique os utilizadores ativos ou desative-os caso seja necessário</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['utilizadorRemovido'])) {

                        $utilizadorRemovido = $_GET['utilizadorRemovido'];
               ...
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    ...
                    if (isset($_GET['utilizadorRemovidoErro'])) {

                        $utilizadorRemovido = $_GET['utilizadorRemovidoErro'];
