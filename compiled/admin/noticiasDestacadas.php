...
<div id="wrapper">
    ...
    Menus('noticias', 'destacadasNoticias');
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-file-text'></i> Notícias Destacadas</h1>

                <h3>Visualize as notícias destacadas ou destaque outras</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['noticiaDestacada'])) {
                        echo "<div class='alert alert-success alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        A notícia foi destacada com sucesso.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['noticiaDestacadaErro'])) {
                        echo "<div class='alert alert-danger alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao destacar a notícia.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    if (isset($_GET['destaqueRemovido'])) {
                        echo "<div class='alert alert-success alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        O destaque da notícia foi removido com sucesso.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    if (isset($_GET['destaqueRemovidoErro'])) {
                        echo "<div class='alert alert-danger alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao remover o destaque a notícia.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>Destacar</strong> Notícia</h2>
                        ...
                        <div class="widget-content padding">
                            <form class="form-horizontal" role="form" method="post"
                                  action="php/verificacoes/noticia/destacar.php">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Notícia</label>

                                    <div class='col-sm-10'>
                                        <select class='form-control selectpicker'
                                                name='noticia' required='required'>
                                            <option disabled selected value=''>Notícia</option>
                                            ...
                                            while (mysqli_stmt_fetch($stmt)) {
                                                echo "<option value='$idNoticias'>".  htmlentities($titulo) ." - " .  htmlentities(ucfirst($tipo))  . "</option>";
                                            }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Notícias</strong> Destacadas</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $destacado = 1;
                                        $query = "SELECT id_noticias, titulo, tipo, data_publicacao 
                                        FROM noticias
                                        WHERE destacado = ?
                                        ORDER BY titulo";
                                        ...
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $destacado);
                                        mysqli_stmt_bind_result($stmt, $idNoticias, $titulo, $tipo, $dataPub);
                                        mysqli_stmt_execute($stmt);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                	<a href='/new/$idNoticias' data-toggle='tooltip' title='Ver Notíca' 
                                                	class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                    <a data-href='php/verificacoes/noticia/removerDestaque.php?noticia=$idNoticias' 
