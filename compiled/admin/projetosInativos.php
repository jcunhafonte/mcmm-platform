...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Ativar Projeto</h3>

        <div>
            <p>Tem a certeza que pretende ativar o projeto <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da ativação pode voltar a desativar o projeto.
                </li>
...
<div id="wrapper">
    ...
    Menus('projetos', 'projetosInativos');
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                ...
                <h3>Verifique os projetos inativos e ative os que pretender</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['projetoAdicionado'])) {

                        $transmissaoRemovida = $_GET['projetoAdicionado'];

                        $query = "SELECT id_projetos, titulo FROM projetos WHERE id_projetos = ?";
               ...
               O projeto <b>$nomeTransmissaoRemovida</b> foi ativado com sucesso.<br>
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['projetoAdicionadoErro'])) {

                        $transmissaoRemovida = $_GET['projetoAdicionadoErro'];
                        ...
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao ativar o projeto <b>$nomeTransmissaoRemovida</b>.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-2" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $ativo = 0;
                                        $query = "SELECT projetos.id_projetos, projetos.titulo, projetos.data_publicacao,
                                        utilizadores.nome_utilizador, utilizadores.id_user, projetos.ref_id_utilizador
                                        FROM projetos
                                        INNER JOIN utilizadores ON utilizadores.id_utilizador = projetos.ref_id_utilizador
                                        WHERE projetos.ativo = ?
                                        ORDER BY projetos.data_publicacao ASC";
                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_param($stmt, 'i', $ativo);
                                        mysqli_stmt_bind_result($stmt, $idProjetos, $titulo, $dataPublicacao,
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    ...
                                                    <a data-href='php/verificacoes/projeto/ativar.php?publicacao=$idProjetos' 
                                                    data-toggle='tooltip' title='Ativar Projeto' class='text-center btn btn-default md-trigger' 
                                                    id='botaoRemover$idProjetos' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' 
                                                    onclick='modalRemover($idProjetos);'><i class='fa fa-check'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
