...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Desativar Vídeo</h3>

        <div>
            <p>Tem a certeza que pretende desativar o vídeo <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da desativação pode voltar a reativar o vídeo.
                </li>
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-sitemap'></i> Vídeos Ativos</h1>

                <h3>Verifique os vídeos ativos e desative os que pretender</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['videoRemovido'])) {

                        $transmissaoRemovida = $_GET['videoRemovido'];
                        ...
                        O vídeo <b>$nomeTransmissaoRemovida</b> foi desativado com sucesso.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['videoRemovidoErro'])) {

                        $transmissaoRemovida = $_GET['videoRemovidoErro'];
                        ...
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao desativar o vídeo <b>$nomeTransmissaoRemovida</b>.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Vídeos</strong> Ativos</h2>
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                	<a href='/video/$idVideos' data-toggle='tooltip' title='Ver Vídeo' 
                                                	class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                    <a data-href='php/verificacoes/video/desativar.php?publicacao=$idVideos' 
                                                    data-toggle='tooltip' title='Desativar Vídeo' class='text-center btn btn-default md-trigger' 
                                                    id='botaoRemover$idVideos' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' 
                                                    onclick='modalRemover($idVideos);'><i class='fa fa-remove'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
