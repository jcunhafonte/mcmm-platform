...
<div id="wrapper">
    ...
    Menus('videos', 'comentariosDanunciadosVideos');
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $query = "SELECT id_denuncia_comentarios_videos, ref_id_utilizador_denunciador,
                                        ref_id_comentario, data_denuncia, ref_id_videos
                                        FROM denuncia_comentarios_videos
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            $query2 = "SELECT comentario FROM comentarios_videos WHERE ref_id_videos = ?";
                                            $stmt2 = mysqli_prepare($link2, $query2);
                                            mysqli_stmt_bind_param($stmt2, 's', $refIdVideos);
                                            mysqli_stmt_execute($stmt2);
                                            mysqli_stmt_bind_result($stmt2, $comentario);
                                            mysqli_stmt_fetch($stmt2);
                                            mysqli_stmt_close($stmt2);

                                            $query2 = "SELECT titulo FROM videos WHERE id_videos = ?";
                                            $stmt2 = mysqli_prepare($link2, $query2);
                                            mysqli_stmt_bind_param($stmt2, 's', $refIdVideos);
                                            mysqli_stmt_execute($stmt2);
                                            mysqli_stmt_bind_result($stmt2, $tituloVideo);
                                            mysqli_stmt_fetch($stmt2);
                                            mysqli_stmt_close($stmt2);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='/video/$refIdVideos'>" . htmlentities($tituloVideo) . "</a>
                                                </td>
                                                <td class='text-center'>
                                                    <div class='btn-group btn-group-xs text-center'>
                                                        <a href='/video/$refIdVideos' data-toggle='tooltip' title='Ver Comentário' 
                                                        class='text-center btn btn-default'><i class='fa fa-eye'></i></a>
                                                        <a data-href='php/verificacoes/video/removerDenunciaComentario.php?comentario=$idDenunciaComentarios' 
