...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Ativar Notícia</h3>

        <div>
            <p>Tem a certeza que pretende ativar a notícia <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da desativação pode voltar a reativar a notícia.
                </li>
...
<div id="wrapper">
    ...
    Menus('noticias', 'noticiasInativas');
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-file-text'></i> Notícias Inativas</h1>

                <h3>Verifique as notícias inativas e ative as que pretender</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['noticiaAdicionada'])) {

                        $transmissaoRemovida = $_GET['noticiaAdicionada'];
               ...
               <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    ...
                    if (isset($_GET['noticiaAdicionadaErro'])) {

                        $transmissaoRemovida = $_GET['noticiaAdicionadaErro'];
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Notícias</strong> Inativas</h2>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-2" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        mysqli_stmt_bind_result($stmt, $idNoticias, $titulo, $dataPublicacao, $tema,
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    ...
                                                    <a data-href='php/verificacoes/noticia/ativar.php?publicacao=$idNoticias' 
                                                    data-toggle='tooltip' title='Ativar Notícia' class='text-center btn btn-default md-trigger' 
                                                    id='botaoRemover$idNoticias' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' 
                                                    onclick='modalRemover($idNoticias);'><i class='fa fa-check'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
