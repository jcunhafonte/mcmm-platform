...
$.fn.bic_calendar = function (a) {
    ...
    return this.each(function () {
        ...
        function k() {
            if (1 == z) {
                p.on("click", "td.day", function () {
                    if (1 == A)if ("" == G)G = $(this).data("date"), l(); else if ("" == F) {
                        E = G, F = $(this).data("date"), l();
                        var a = new CustomEvent("bicCalendarSelect", {detail: {dateFirst: E, dateLast: F}});
                        document.dispatchEvent(a)
                    } else E = "", F = "", G = "", p.find(".selection").removeClass("middle-selection selection first-selection last-selection"); else {
        ...
        var w;
        w = "undefined" != typeof b.popoverOptions ? b.popoverOptions : {
            placement: "bottom",
            html: !0,
            trigger: "hover"
        };
