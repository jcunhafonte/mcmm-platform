    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-building'></i> Parceiros</h1>

                <h3>Visualize os parceiros apresentados na Splash</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['parceiroAdicionado'])) {
                        echo "<div class='alert alert-success alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        O parceiro foi adicionado com sucesso.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['parceiroAdicionadoErro'])) {
                    ...
                    if (isset($_GET['parceiroRemovido'])) {
                        echo "<div class='alert alert-success alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                    ...
                    if (isset($_GET['parceiroRemovidoErro'])) {
                        echo "<div class='alert alert-danger alert-dismissable'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                    ...
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>Adicionar</strong> parceiro</h2>
                        ...
                        <div class="widget-content padding">
                            <form class="form-horizontal" role="form" method="post"
                                  enctype="multipart/form-data" action="php/verificacoes/adicionarParceiro.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='col-sm-2'>
                                        <input type="text" name="url" required
                                               class="form-control" placeholder="Insira o link da página"/>
                                    </div>

                                    <label class="col-sm-1 control-label">Logótipo</label>

                                    <div class='col-sm-2'>
                                        <input type="file" id="input-id" name="logotipo" required
                                               accept="image/png" class="form-control"
                                               title="Insira o logótipo (PNG)"/>
                                    </div>
                            ...
                            <div class="table-responsive" style="overflow-x: hidden">
                                <form class='form-horizontal' role='form'>
                                    <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        $query = "SELECT id_parceiros, nome, url
                                        FROM parceiros
                                        ORDER BY nome";

                                        $stmt = mysqli_prepare($link, $query);
                                        mysqli_stmt_bind_result($stmt, $idParceiros, $nome, $url);
                                        mysqli_stmt_execute($stmt);

                                        while (mysqli_stmt_fetch($stmt)) {

                                            echo "<tr>
                                            <td style='background: black' class='text-center'>";
                                            echo "<img height='50px' 
                                            src='../api/utilizadores/parceiros/$idParceiros.png'/>";
                                            echo "</td>
                                            <td>
                                                <a href='/'>
                                                <span id='titulo$idParceiros'>" . htmlentities($nome) . "</span>
                                                </a>
                                            </td>
                                            <td><a href='$url' target='_blank'>$url</a></td>
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                	<a data-href='php/verificacoes/removerParceiro.php?parceiro=$idParceiros' 
                                                    data-toggle='tooltip' title='Eliminar Parceiro' class='text-center btn btn-default md-trigger' 
                                                    id='botaoRemover$idParceiros' data-target='#md-fade-in-scale-up' data-modal='md-fade-in-scale-up' 
                                                    onclick='modalRemover($idParceiros);'><i class='fa fa-remove'></i></a>
                                                </div>
                                            </td>
                                        </tr>";
                                        }
