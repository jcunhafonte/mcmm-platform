...
<div class='md-modal md-fade-in-scale-up' id='md-fade-in-scale-up'>
    <div class='md-content'>
        <h3>Desativar Projeto</h3>

        <div>
            <p>Tem a certeza que pretende desativar o projeto <strong><span id='alteravel'></span></strong>?</p>
            <ul>
                <li><strong>Atenção:</strong> Esta ação pode ser revertida.
                </li>
                <li><strong>Informação:</strong> Após a confirmação da desativação pode voltar a reativar o projeto.
                </li>
...
<!--        </ol>-->
        ...
        <div class="content">
            ...
            <div class="page-heading">
                <h1><i class='fa fa-sitemap'></i> Projetos Ativos</h1>

                <h3>Verifique os projetos ativos e desative os que pretender</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    if (isset($_GET['projetoRemovido'])) {

                        $transmissaoRemovida = $_GET['projetoRemovido'];
                        ...
                        O projeto <b>$nomeTransmissaoRemovida</b> foi desativado com sucesso.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }

                    if (isset($_GET['projetoRemovidoErro'])) {

                        $transmissaoRemovida = $_GET['projetoRemovidoErro'];
                        ...
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                        Ocorreu um erro ao desativar o projeto <b>$nomeTransmissaoRemovida</b>.<br>
                        <a class='alert-link'>Votos de uma excelente experiência!</a></div>";
                    }
                    ...
                    <div class="widget">
                        <div class="widget-header">
                            <h2><strong>Projetos</strong> Ativos</h2>
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            ...
                                            <td class='text-center'>
                                                <div class='btn-group btn-group-xs text-center'>
                                                    ...
                                                    <a data-href='php/verificacoes/projeto/desativar.php?publicacao=$idProjetos' 
                                                    data-toggle='tooltip' title='Desativar Projeto' class='text-center btn btn-default md-trigger' 
